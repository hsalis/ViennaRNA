...
struct gengetopt_args_info
{
  ...
  int stop_flag;	/**< @brief read stop structure(s) from stdin (otherwise use MFE) (default=off).  */
  const char *stop_help; /**< @brief read stop structure(s) from stdin (otherwise use MFE) help description.  */
