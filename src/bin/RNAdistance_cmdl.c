/*
  ...
  /usr/local/bin/gengetopt -i RNAdistance.ggo --file-name=RNAdistance_cmdl --include-getopt --default-optional --func-name=RNAdistance_cmdline_parser --arg-struct-name=RNAdistance_args_info
...
const char *RNAdistance_args_info_usage = "Usage: RNAdistance [OPTION]...";
...
{
  RNAdistance_args_info_full_help[0] = RNAdistance_args_info_detailed_help[0];
  RNAdistance_args_info_full_help[1] = RNAdistance_args_info_detailed_help[1];
  RNAdistance_args_info_full_help[2] = RNAdistance_args_info_detailed_help[2];
  RNAdistance_args_info_full_help[3] = RNAdistance_args_info_detailed_help[3];
  RNAdistance_args_info_full_help[4] = RNAdistance_args_info_detailed_help[4];
  RNAdistance_args_info_full_help[5] = RNAdistance_args_info_detailed_help[6];
  RNAdistance_args_info_full_help[6] = RNAdistance_args_info_detailed_help[8];
  RNAdistance_args_info_full_help[7] = RNAdistance_args_info_detailed_help[10];
  RNAdistance_args_info_full_help[8] = RNAdistance_args_info_detailed_help[11];
  RNAdistance_args_info_full_help[9] = RNAdistance_args_info_detailed_help[13];
  RNAdistance_args_info_full_help[10] = RNAdistance_args_info_detailed_help[15];
  RNAdistance_args_info_full_help[11] = RNAdistance_args_info_detailed_help[16];
  RNAdistance_args_info_full_help[12] = RNAdistance_args_info_detailed_help[17];
  RNAdistance_args_info_full_help[13] = RNAdistance_args_info_detailed_help[18];
  RNAdistance_args_info_full_help[14] = 0; 
  
}

const char *RNAdistance_args_info_full_help[15];
...
init_help_array(void)
{
  ...
  RNAdistance_args_info_help[4] = RNAdistance_args_info_detailed_help[4];
  RNAdistance_args_info_help[5] = RNAdistance_args_info_detailed_help[6];
  ...
  RNAdistance_args_info_help[8] = RNAdistance_args_info_detailed_help[11];
  RNAdistance_args_info_help[9] = RNAdistance_args_info_detailed_help[18];
  RNAdistance_args_info_help[10] = 0; 
  
}

const char *RNAdistance_args_info_help[11];
...
void clear_args (struct RNAdistance_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAdist.log");
...
void init_args_info(struct RNAdistance_args_info *args_info)
{
  ...
  args_info->full_help_help = RNAdistance_args_info_detailed_help[2] ;
  args_info->version_help = RNAdistance_args_info_detailed_help[3] ;
  args_info->verbose_help = RNAdistance_args_info_detailed_help[4] ;
  args_info->distance_help = RNAdistance_args_info_detailed_help[6] ;
  args_info->compare_help = RNAdistance_args_info_detailed_help[8] ;
  args_info->shapiro_help = RNAdistance_args_info_detailed_help[10] ;
  args_info->backtrack_help = RNAdistance_args_info_detailed_help[11] ;
  args_info->log_level_help = RNAdistance_args_info_detailed_help[13] ;
  args_info->log_file_help = RNAdistance_args_info_detailed_help[15] ;
  args_info->log_time_help = RNAdistance_args_info_detailed_help[16] ;
  args_info->log_call_help = RNAdistance_args_info_detailed_help[17] ;
...
{
	size_t len_purpose = strlen(RNAdistance_args_info_purpose);
	size_t len_usage = strlen(RNAdistance_args_info_usage);
...
void
RNAdistance_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAdistance_args_info_full_help[i])
    printf("%s\n", RNAdistance_args_info_full_help[i++]);
}
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvD:X:SB::", long_options, &option_index);
...
.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            RNAdistance_cmdline_parser_print_full_help ();
            RNAdistance_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAdist.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
