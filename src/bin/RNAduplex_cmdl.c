/*
  ...
  /usr/local/bin/gengetopt -i RNAduplex.ggo --file-name=RNAduplex_cmdl --include-getopt --default-optional --func-name=RNAduplex_cmdline_parser --arg-struct-name=RNAduplex_args_info
...
init_full_help_array(void)
{
  ...
  RNAduplex_args_info_full_help[5] = RNAduplex_args_info_detailed_help[6];
  RNAduplex_args_info_full_help[6] = RNAduplex_args_info_detailed_help[7];
  RNAduplex_args_info_full_help[7] = RNAduplex_args_info_detailed_help[8];
  RNAduplex_args_info_full_help[8] = RNAduplex_args_info_detailed_help[9];
  RNAduplex_args_info_full_help[9] = RNAduplex_args_info_detailed_help[10];
  RNAduplex_args_info_full_help[10] = RNAduplex_args_info_detailed_help[12];
  RNAduplex_args_info_full_help[11] = RNAduplex_args_info_detailed_help[13];
  RNAduplex_args_info_full_help[12] = RNAduplex_args_info_detailed_help[14];
  RNAduplex_args_info_full_help[13] = RNAduplex_args_info_detailed_help[15];
  RNAduplex_args_info_full_help[14] = RNAduplex_args_info_detailed_help[16];
  RNAduplex_args_info_full_help[15] = RNAduplex_args_info_detailed_help[17];
  ...
  RNAduplex_args_info_full_help[20] = RNAduplex_args_info_detailed_help[23];
  RNAduplex_args_info_full_help[21] = RNAduplex_args_info_detailed_help[25];
  ...
  RNAduplex_args_info_full_help[25] = RNAduplex_args_info_detailed_help[29];
  RNAduplex_args_info_full_help[26] = RNAduplex_args_info_detailed_help[31];
  RNAduplex_args_info_full_help[27] = RNAduplex_args_info_detailed_help[33];
  RNAduplex_args_info_full_help[28] = RNAduplex_args_info_detailed_help[34];
  RNAduplex_args_info_full_help[29] = RNAduplex_args_info_detailed_help[35];
  RNAduplex_args_info_full_help[30] = RNAduplex_args_info_detailed_help[37];
  RNAduplex_args_info_full_help[31] = RNAduplex_args_info_detailed_help[39];
  RNAduplex_args_info_full_help[32] = RNAduplex_args_info_detailed_help[41];
  RNAduplex_args_info_full_help[33] = 0; 
  
}

const char *RNAduplex_args_info_full_help[34];
...
init_help_array(void)
{
  ...
  RNAduplex_args_info_help[5] = RNAduplex_args_info_detailed_help[6];
  RNAduplex_args_info_help[6] = RNAduplex_args_info_detailed_help[7];
  RNAduplex_args_info_help[7] = RNAduplex_args_info_detailed_help[8];
  RNAduplex_args_info_help[8] = RNAduplex_args_info_detailed_help[9];
  RNAduplex_args_info_help[9] = RNAduplex_args_info_detailed_help[15];
  RNAduplex_args_info_help[10] = RNAduplex_args_info_detailed_help[16];
  RNAduplex_args_info_help[11] = RNAduplex_args_info_detailed_help[17];
  RNAduplex_args_info_help[12] = RNAduplex_args_info_detailed_help[18];
  RNAduplex_args_info_help[13] = RNAduplex_args_info_detailed_help[19];
  RNAduplex_args_info_help[14] = RNAduplex_args_info_detailed_help[20];
  RNAduplex_args_info_help[15] = RNAduplex_args_info_detailed_help[21];
  RNAduplex_args_info_help[16] = RNAduplex_args_info_detailed_help[25];
  RNAduplex_args_info_help[17] = RNAduplex_args_info_detailed_help[27];
  RNAduplex_args_info_help[18] = RNAduplex_args_info_detailed_help[28];
  RNAduplex_args_info_help[19] = RNAduplex_args_info_detailed_help[29];
  RNAduplex_args_info_help[20] = RNAduplex_args_info_detailed_help[31];
  RNAduplex_args_info_help[21] = RNAduplex_args_info_detailed_help[41];
  RNAduplex_args_info_help[22] = 0; 
  
}

const char *RNAduplex_args_info_help[23];
...
void clear_args (struct RNAduplex_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAduplex.log");
...
void init_args_info(struct RNAduplex_args_info *args_info)
{
  ...
  args_info->verbose_help = RNAduplex_args_info_detailed_help[4] ;
  args_info->sorted_help = RNAduplex_args_info_detailed_help[8] ;
  args_info->noconv_help = RNAduplex_args_info_detailed_help[9] ;
  args_info->log_level_help = RNAduplex_args_info_detailed_help[10] ;
  args_info->log_file_help = RNAduplex_args_info_detailed_help[12] ;
  args_info->log_time_help = RNAduplex_args_info_detailed_help[13] ;
  args_info->log_call_help = RNAduplex_args_info_detailed_help[14] ;
  args_info->deltaEnergy_help = RNAduplex_args_info_detailed_help[17] ;
  args_info->temp_help = RNAduplex_args_info_detailed_help[20] ;
  args_info->paramFile_help = RNAduplex_args_info_detailed_help[21] ;
  args_info->noTetra_help = RNAduplex_args_info_detailed_help[23] ;
  args_info->salt_help = RNAduplex_args_info_detailed_help[25] ;
  args_info->saltInit_help = RNAduplex_args_info_detailed_help[26] ;
  args_info->dangles_help = RNAduplex_args_info_detailed_help[29] ;
  args_info->noLP_help = RNAduplex_args_info_detailed_help[31] ;
  args_info->noGU_help = RNAduplex_args_info_detailed_help[33] ;
  args_info->noClosingGU_help = RNAduplex_args_info_detailed_help[34] ;
  args_info->nsp_help = RNAduplex_args_info_detailed_help[35] ;
  args_info->helical_rise_help = RNAduplex_args_info_detailed_help[37] ;
  args_info->backbone_length_help = RNAduplex_args_info_detailed_help[39] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvse:T:P:4d:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAduplex.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
