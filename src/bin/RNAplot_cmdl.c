/*
  ...
  /usr/local/bin/gengetopt -i RNAplot.ggo --file-name=RNAplot_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAplot_cmdline_parser --arg-struct-name=RNAplot_args_info
