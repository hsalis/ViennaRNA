/*
  ...
  /usr/local/bin/gengetopt -i RNAplfold.ggo --file-name=RNAplfold_cmdl --include-getopt --default-optional --func-name=RNAplfold_cmdline_parser --arg-struct-name=RNAplfold_args_info
...
init_full_help_array(void)
{
  ...
  RNAplfold_args_info_full_help[5] = RNAplfold_args_info_detailed_help[6];
  RNAplfold_args_info_full_help[6] = RNAplfold_args_info_detailed_help[7];
  RNAplfold_args_info_full_help[7] = RNAplfold_args_info_detailed_help[8];
  RNAplfold_args_info_full_help[8] = RNAplfold_args_info_detailed_help[9];
  RNAplfold_args_info_full_help[9] = RNAplfold_args_info_detailed_help[11];
  RNAplfold_args_info_full_help[10] = RNAplfold_args_info_detailed_help[13];
  RNAplfold_args_info_full_help[11] = RNAplfold_args_info_detailed_help[14];
  RNAplfold_args_info_full_help[12] = RNAplfold_args_info_detailed_help[16];
  RNAplfold_args_info_full_help[13] = RNAplfold_args_info_detailed_help[17];
  RNAplfold_args_info_full_help[14] = RNAplfold_args_info_detailed_help[19];
  RNAplfold_args_info_full_help[15] = RNAplfold_args_info_detailed_help[21];
  RNAplfold_args_info_full_help[16] = RNAplfold_args_info_detailed_help[23];
  RNAplfold_args_info_full_help[17] = RNAplfold_args_info_detailed_help[25];
  RNAplfold_args_info_full_help[18] = RNAplfold_args_info_detailed_help[27];
  RNAplfold_args_info_full_help[19] = RNAplfold_args_info_detailed_help[29];
  RNAplfold_args_info_full_help[20] = RNAplfold_args_info_detailed_help[31];
  RNAplfold_args_info_full_help[21] = RNAplfold_args_info_detailed_help[33];
  RNAplfold_args_info_full_help[22] = RNAplfold_args_info_detailed_help[34];
  RNAplfold_args_info_full_help[23] = RNAplfold_args_info_detailed_help[35];
  ...
  RNAplfold_args_info_full_help[26] = RNAplfold_args_info_detailed_help[38];
  RNAplfold_args_info_full_help[27] = RNAplfold_args_info_detailed_help[39];
  RNAplfold_args_info_full_help[28] = RNAplfold_args_info_detailed_help[41];
  RNAplfold_args_info_full_help[29] = RNAplfold_args_info_detailed_help[43];
  RNAplfold_args_info_full_help[30] = RNAplfold_args_info_detailed_help[45];
  RNAplfold_args_info_full_help[31] = RNAplfold_args_info_detailed_help[47];
  RNAplfold_args_info_full_help[32] = RNAplfold_args_info_detailed_help[48];
  RNAplfold_args_info_full_help[33] = RNAplfold_args_info_detailed_help[49];
  RNAplfold_args_info_full_help[34] = RNAplfold_args_info_detailed_help[50];
  RNAplfold_args_info_full_help[35] = RNAplfold_args_info_detailed_help[52];
  RNAplfold_args_info_full_help[36] = RNAplfold_args_info_detailed_help[54];
  RNAplfold_args_info_full_help[37] = RNAplfold_args_info_detailed_help[56];
  ...
  RNAplfold_args_info_full_help[40] = RNAplfold_args_info_detailed_help[59];
  RNAplfold_args_info_full_help[41] = RNAplfold_args_info_detailed_help[61];
  RNAplfold_args_info_full_help[42] = RNAplfold_args_info_detailed_help[63];
  RNAplfold_args_info_full_help[43] = RNAplfold_args_info_detailed_help[64];
  RNAplfold_args_info_full_help[44] = RNAplfold_args_info_detailed_help[66];
  ...
  RNAplfold_args_info_full_help[50] = RNAplfold_args_info_detailed_help[74];
  RNAplfold_args_info_full_help[51] = RNAplfold_args_info_detailed_help[75];
  RNAplfold_args_info_full_help[52] = RNAplfold_args_info_detailed_help[77];
  RNAplfold_args_info_full_help[53] = RNAplfold_args_info_detailed_help[79];
  RNAplfold_args_info_full_help[54] = RNAplfold_args_info_detailed_help[81];
  RNAplfold_args_info_full_help[55] = RNAplfold_args_info_detailed_help[83];
  RNAplfold_args_info_full_help[56] = 0; 
  
}

const char *RNAplfold_args_info_full_help[57];
...
init_help_array(void)
{
  ...
  RNAplfold_args_info_help[5] = RNAplfold_args_info_detailed_help[6];
  RNAplfold_args_info_help[6] = RNAplfold_args_info_detailed_help[7];
  RNAplfold_args_info_help[7] = RNAplfold_args_info_detailed_help[8];
  RNAplfold_args_info_help[8] = RNAplfold_args_info_detailed_help[9];
  RNAplfold_args_info_help[9] = RNAplfold_args_info_detailed_help[11];
  RNAplfold_args_info_help[10] = RNAplfold_args_info_detailed_help[16];
  RNAplfold_args_info_help[11] = RNAplfold_args_info_detailed_help[17];
  RNAplfold_args_info_help[12] = RNAplfold_args_info_detailed_help[19];
  RNAplfold_args_info_help[13] = RNAplfold_args_info_detailed_help[36];
  RNAplfold_args_info_help[14] = RNAplfold_args_info_detailed_help[37];
  RNAplfold_args_info_help[15] = RNAplfold_args_info_detailed_help[38];
  RNAplfold_args_info_help[16] = RNAplfold_args_info_detailed_help[39];
  RNAplfold_args_info_help[17] = RNAplfold_args_info_detailed_help[41];
  RNAplfold_args_info_help[18] = RNAplfold_args_info_detailed_help[47];
  RNAplfold_args_info_help[19] = RNAplfold_args_info_detailed_help[48];
  RNAplfold_args_info_help[20] = RNAplfold_args_info_detailed_help[49];
  RNAplfold_args_info_help[21] = RNAplfold_args_info_detailed_help[56];
  RNAplfold_args_info_help[22] = RNAplfold_args_info_detailed_help[57];
  RNAplfold_args_info_help[23] = RNAplfold_args_info_detailed_help[58];
  RNAplfold_args_info_help[24] = RNAplfold_args_info_detailed_help[59];
  RNAplfold_args_info_help[25] = RNAplfold_args_info_detailed_help[63];
  RNAplfold_args_info_help[26] = RNAplfold_args_info_detailed_help[64];
  RNAplfold_args_info_help[27] = RNAplfold_args_info_detailed_help[66];
  RNAplfold_args_info_help[28] = RNAplfold_args_info_detailed_help[67];
  RNAplfold_args_info_help[29] = RNAplfold_args_info_detailed_help[68];
  RNAplfold_args_info_help[30] = RNAplfold_args_info_detailed_help[69];
  RNAplfold_args_info_help[31] = RNAplfold_args_info_detailed_help[71];
  RNAplfold_args_info_help[32] = RNAplfold_args_info_detailed_help[83];
...
void clear_args (struct RNAplfold_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAplfold.log");
...
void init_args_info(struct RNAplfold_args_info *args_info)
{
  ...
  args_info->binaries_help = RNAplfold_args_info_detailed_help[14] ;
  args_info->noconv_help = RNAplfold_args_info_detailed_help[16] ;
  args_info->auto_id_help = RNAplfold_args_info_detailed_help[17] ;
  args_info->id_prefix_help = RNAplfold_args_info_detailed_help[19] ;
  args_info->id_delim_help = RNAplfold_args_info_detailed_help[21] ;
  args_info->id_digits_help = RNAplfold_args_info_detailed_help[23] ;
  args_info->id_start_help = RNAplfold_args_info_detailed_help[25] ;
  args_info->filename_delim_help = RNAplfold_args_info_detailed_help[27] ;
  args_info->filename_full_help = RNAplfold_args_info_detailed_help[29] ;
  args_info->log_level_help = RNAplfold_args_info_detailed_help[31] ;
  args_info->log_file_help = RNAplfold_args_info_detailed_help[33] ;
  args_info->log_time_help = RNAplfold_args_info_detailed_help[34] ;
  args_info->log_call_help = RNAplfold_args_info_detailed_help[35] ;
  args_info->winsize_help = RNAplfold_args_info_detailed_help[38] ;
  args_info->span_help = RNAplfold_args_info_detailed_help[39] ;
  args_info->ulength_help = RNAplfold_args_info_detailed_help[41] ;
  args_info->betaScale_help = RNAplfold_args_info_detailed_help[43] ;
  args_info->pfScale_help = RNAplfold_args_info_detailed_help[45] ;
  args_info->shape_help = RNAplfold_args_info_detailed_help[49] ;
  args_info->shapeMethod_help = RNAplfold_args_info_detailed_help[50] ;
  args_info->shapeConversion_help = RNAplfold_args_info_detailed_help[52] ;
  args_info->commands_help = RNAplfold_args_info_detailed_help[54] ;
  args_info->temp_help = RNAplfold_args_info_detailed_help[58] ;
  args_info->paramFile_help = RNAplfold_args_info_detailed_help[59] ;
  args_info->noTetra_help = RNAplfold_args_info_detailed_help[61] ;
  args_info->salt_help = RNAplfold_args_info_detailed_help[63] ;
  args_info->modifications_help = RNAplfold_args_info_detailed_help[64] ;
  args_info->mod_file_help = RNAplfold_args_info_detailed_help[66] ;
  args_info->mod_file_min = 0;
  args_info->mod_file_max = 0;
  args_info->dangles_help = RNAplfold_args_info_detailed_help[69] ;
  args_info->noLP_help = RNAplfold_args_info_detailed_help[71] ;
  args_info->noGU_help = RNAplfold_args_info_detailed_help[73] ;
  args_info->noClosingGU_help = RNAplfold_args_info_detailed_help[74] ;
  args_info->nsp_help = RNAplfold_args_info_detailed_help[75] ;
  args_info->energyModel_help = RNAplfold_args_info_detailed_help[77] ;
  args_info->helical_rise_help = RNAplfold_args_info_detailed_help[79] ;
  args_info->backbone_length_help = RNAplfold_args_info_detailed_help[81] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvc:oObW:L:u:S:T:P:4m::d:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAplfold.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
