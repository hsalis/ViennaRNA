...
.  */
 ...
 help description.  */
  int bm_rm_nc_flag;	/**< @brief Remove non-canonical base pairs from the reference structure before computing benchmark.
  
 (default=off).  */
  const char *bm_rm_nc_help; /**< @brief Remove non-canonical base pairs from the reference structure before computing benchmark.
...
.  */
 ...
 help description.  */
  ...
  unsigned int bm_rm_nc_given ;	/**< @brief Whether bm-rm-nc was given.  */
