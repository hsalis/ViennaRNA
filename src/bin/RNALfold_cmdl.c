/*
  ...
  /usr/local/bin/gengetopt -i RNALfold.ggo --file-name=RNALfold_cmdl --include-getopt --default-optional --func-name=RNALfold_cmdline_parser --arg-struct-name=RNALfold_args_info
...
init_full_help_array(void)
{
  ...
  RNALfold_args_info_full_help[5] = RNALfold_args_info_detailed_help[6];
  RNALfold_args_info_full_help[6] = RNALfold_args_info_detailed_help[7];
  RNALfold_args_info_full_help[7] = RNALfold_args_info_detailed_help[8];
  RNALfold_args_info_full_help[8] = RNALfold_args_info_detailed_help[10];
  RNALfold_args_info_full_help[9] = RNALfold_args_info_detailed_help[12];
  RNALfold_args_info_full_help[10] = RNALfold_args_info_detailed_help[13];
  RNALfold_args_info_full_help[11] = RNALfold_args_info_detailed_help[15];
  RNALfold_args_info_full_help[12] = RNALfold_args_info_detailed_help[17];
  RNALfold_args_info_full_help[13] = RNALfold_args_info_detailed_help[19];
  RNALfold_args_info_full_help[14] = RNALfold_args_info_detailed_help[21];
  RNALfold_args_info_full_help[15] = RNALfold_args_info_detailed_help[23];
  RNALfold_args_info_full_help[16] = RNALfold_args_info_detailed_help[25];
  RNALfold_args_info_full_help[17] = RNALfold_args_info_detailed_help[27];
  RNALfold_args_info_full_help[18] = RNALfold_args_info_detailed_help[29];
  ...
  RNALfold_args_info_full_help[22] = RNALfold_args_info_detailed_help[33];
  RNALfold_args_info_full_help[23] = RNALfold_args_info_detailed_help[34];
  ...
  RNALfold_args_info_full_help[29] = RNALfold_args_info_detailed_help[45];
  RNALfold_args_info_full_help[30] = RNALfold_args_info_detailed_help[46];
  RNALfold_args_info_full_help[31] = RNALfold_args_info_detailed_help[47];
  ...
  RNALfold_args_info_full_help[42] = RNALfold_args_info_detailed_help[64];
  ...
  RNALfold_args_info_full_help[48] = RNALfold_args_info_detailed_help[72];
  RNALfold_args_info_full_help[49] = RNALfold_args_info_detailed_help[73];
  RNALfold_args_info_full_help[50] = RNALfold_args_info_detailed_help[75];
  RNALfold_args_info_full_help[51] = RNALfold_args_info_detailed_help[77];
  RNALfold_args_info_full_help[52] = RNALfold_args_info_detailed_help[79];
  RNALfold_args_info_full_help[53] = RNALfold_args_info_detailed_help[81];
  RNALfold_args_info_full_help[54] = 0; 
  
}

const char *RNALfold_args_info_full_help[55];
...
init_help_array(void)
{
  ...
  RNALfold_args_info_help[5] = RNALfold_args_info_detailed_help[6];
  RNALfold_args_info_help[6] = RNALfold_args_info_detailed_help[7];
  RNALfold_args_info_help[7] = RNALfold_args_info_detailed_help[8];
  ...
  RNALfold_args_info_help[10] = RNALfold_args_info_detailed_help[13];
  RNALfold_args_info_help[11] = RNALfold_args_info_detailed_help[15];
  RNALfold_args_info_help[12] = RNALfold_args_info_detailed_help[32];
  RNALfold_args_info_help[13] = RNALfold_args_info_detailed_help[33];
  ...
  RNALfold_args_info_help[20] = RNALfold_args_info_detailed_help[45];
  RNALfold_args_info_help[21] = RNALfold_args_info_detailed_help[46];
  RNALfold_args_info_help[22] = RNALfold_args_info_detailed_help[47];
  RNALfold_args_info_help[23] = RNALfold_args_info_detailed_help[54];
  RNALfold_args_info_help[24] = RNALfold_args_info_detailed_help[55];
  RNALfold_args_info_help[25] = RNALfold_args_info_detailed_help[56];
  RNALfold_args_info_help[26] = RNALfold_args_info_detailed_help[57];
  RNALfold_args_info_help[27] = RNALfold_args_info_detailed_help[61];
  RNALfold_args_info_help[28] = RNALfold_args_info_detailed_help[62];
  RNALfold_args_info_help[29] = RNALfold_args_info_detailed_help[64];
  RNALfold_args_info_help[30] = RNALfold_args_info_detailed_help[65];
  RNALfold_args_info_help[31] = RNALfold_args_info_detailed_help[66];
  RNALfold_args_info_help[32] = RNALfold_args_info_detailed_help[67];
  RNALfold_args_info_help[33] = RNALfold_args_info_detailed_help[69];
  RNALfold_args_info_help[34] = RNALfold_args_info_detailed_help[81];
...
void clear_args (struct RNALfold_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNALfold.log");
...
void init_args_info(struct RNALfold_args_info *args_info)
{
  ...
  args_info->infile_help = RNALfold_args_info_detailed_help[8] ;
  args_info->outfile_help = RNALfold_args_info_detailed_help[10] ;
  args_info->noconv_help = RNALfold_args_info_detailed_help[12] ;
  args_info->auto_id_help = RNALfold_args_info_detailed_help[13] ;
  args_info->id_prefix_help = RNALfold_args_info_detailed_help[15] ;
  args_info->id_delim_help = RNALfold_args_info_detailed_help[17] ;
  args_info->id_digits_help = RNALfold_args_info_detailed_help[19] ;
  args_info->id_start_help = RNALfold_args_info_detailed_help[21] ;
  args_info->filename_delim_help = RNALfold_args_info_detailed_help[23] ;
  args_info->filename_full_help = RNALfold_args_info_detailed_help[25] ;
  args_info->log_level_help = RNALfold_args_info_detailed_help[27] ;
  args_info->log_file_help = RNALfold_args_info_detailed_help[29] ;
  args_info->log_time_help = RNALfold_args_info_detailed_help[30] ;
  args_info->log_call_help = RNALfold_args_info_detailed_help[31] ;
  args_info->span_help = RNALfold_args_info_detailed_help[34] ;
  args_info->zscore_help = RNALfold_args_info_detailed_help[36] ;
  args_info->zscore_pre_filter_help = RNALfold_args_info_detailed_help[38] ;
  args_info->zscore_report_subsumed_help = RNALfold_args_info_detailed_help[40] ;
  args_info->backtrack_global_help = RNALfold_args_info_detailed_help[42] ;
  args_info->gquad_help = RNALfold_args_info_detailed_help[44] ;
  args_info->shape_help = RNALfold_args_info_detailed_help[47] ;
  args_info->shapeMethod_help = RNALfold_args_info_detailed_help[48] ;
  args_info->shapeConversion_help = RNALfold_args_info_detailed_help[50] ;
  args_info->commands_help = RNALfold_args_info_detailed_help[52] ;
  args_info->temp_help = RNALfold_args_info_detailed_help[56] ;
  args_info->paramFile_help = RNALfold_args_info_detailed_help[57] ;
  args_info->noTetra_help = RNALfold_args_info_detailed_help[59] ;
  args_info->salt_help = RNALfold_args_info_detailed_help[61] ;
  args_info->modifications_help = RNALfold_args_info_detailed_help[62] ;
  args_info->mod_file_help = RNALfold_args_info_detailed_help[64] ;
  args_info->mod_file_min = 0;
  args_info->mod_file_max = 0;
  args_info->dangles_help = RNALfold_args_info_detailed_help[67] ;
  args_info->noLP_help = RNALfold_args_info_detailed_help[69] ;
  args_info->noGU_help = RNALfold_args_info_detailed_help[71] ;
  args_info->noClosingGU_help = RNALfold_args_info_detailed_help[72] ;
  args_info->nsp_help = RNALfold_args_info_detailed_help[73] ;
  args_info->energyModel_help = RNALfold_args_info_detailed_help[75] ;
  args_info->helical_rise_help = RNALfold_args_info_detailed_help[77] ;
  args_info->backbone_length_help = RNALfold_args_info_detailed_help[79] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvi:o::L:z::bgT:P:4m::d:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNALfold.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
