/*
  ...
  /usr/local/bin/gengetopt -i RNAdos.ggo --file-name=RNAdos_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAdos_cmdline_parser --arg-struct-name=RNAdos_args_info
...
init_full_help_array(void)
{
  ...
  RNAdos_args_info_full_help[5] = RNAdos_args_info_detailed_help[6];
  RNAdos_args_info_full_help[6] = RNAdos_args_info_detailed_help[7];
  RNAdos_args_info_full_help[7] = RNAdos_args_info_detailed_help[8];
  RNAdos_args_info_full_help[8] = RNAdos_args_info_detailed_help[9];
  RNAdos_args_info_full_help[9] = RNAdos_args_info_detailed_help[10];
  RNAdos_args_info_full_help[10] = RNAdos_args_info_detailed_help[12];
  RNAdos_args_info_full_help[11] = RNAdos_args_info_detailed_help[13];
  RNAdos_args_info_full_help[12] = RNAdos_args_info_detailed_help[14];
  RNAdos_args_info_full_help[13] = RNAdos_args_info_detailed_help[15];
  RNAdos_args_info_full_help[14] = RNAdos_args_info_detailed_help[16];
  RNAdos_args_info_full_help[15] = RNAdos_args_info_detailed_help[17];
  RNAdos_args_info_full_help[16] = RNAdos_args_info_detailed_help[18];
  RNAdos_args_info_full_help[17] = RNAdos_args_info_detailed_help[19];
  RNAdos_args_info_full_help[18] = RNAdos_args_info_detailed_help[20];
  RNAdos_args_info_full_help[19] = RNAdos_args_info_detailed_help[21];
  RNAdos_args_info_full_help[20] = RNAdos_args_info_detailed_help[22];
  RNAdos_args_info_full_help[21] = RNAdos_args_info_detailed_help[24];
  RNAdos_args_info_full_help[22] = RNAdos_args_info_detailed_help[25];
  RNAdos_args_info_full_help[23] = RNAdos_args_info_detailed_help[26];
  RNAdos_args_info_full_help[24] = RNAdos_args_info_detailed_help[27];
  RNAdos_args_info_full_help[25] = RNAdos_args_info_detailed_help[29];
  RNAdos_args_info_full_help[26] = RNAdos_args_info_detailed_help[31];
  RNAdos_args_info_full_help[27] = RNAdos_args_info_detailed_help[33];
  RNAdos_args_info_full_help[28] = 0; 
  
}

const char *RNAdos_args_info_full_help[29];
...
init_help_array(void)
{
  ...
  RNAdos_args_info_help[5] = RNAdos_args_info_detailed_help[6];
  RNAdos_args_info_help[6] = RNAdos_args_info_detailed_help[7];
  RNAdos_args_info_help[7] = RNAdos_args_info_detailed_help[8];
  RNAdos_args_info_help[8] = RNAdos_args_info_detailed_help[9];
  RNAdos_args_info_help[9] = RNAdos_args_info_detailed_help[15];
  RNAdos_args_info_help[10] = RNAdos_args_info_detailed_help[16];
  RNAdos_args_info_help[11] = RNAdos_args_info_detailed_help[17];
  RNAdos_args_info_help[12] = RNAdos_args_info_detailed_help[19];
  RNAdos_args_info_help[13] = RNAdos_args_info_detailed_help[20];
  RNAdos_args_info_help[14] = RNAdos_args_info_detailed_help[21];
  RNAdos_args_info_help[15] = RNAdos_args_info_detailed_help[22];
  RNAdos_args_info_help[16] = RNAdos_args_info_detailed_help[24];
  RNAdos_args_info_help[17] = RNAdos_args_info_detailed_help[25];
  RNAdos_args_info_help[18] = RNAdos_args_info_detailed_help[26];
  RNAdos_args_info_help[19] = RNAdos_args_info_detailed_help[27];
  RNAdos_args_info_help[20] = RNAdos_args_info_detailed_help[33];
...
void clear_args (struct RNAdos_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAdos.log");
...
void init_args_info(struct RNAdos_args_info *args_info)
{
  ...
  args_info->sequence_help = RNAdos_args_info_detailed_help[8] ;
  args_info->numThreads_help = RNAdos_args_info_detailed_help[9] ;
  args_info->log_level_help = RNAdos_args_info_detailed_help[10] ;
  args_info->log_file_help = RNAdos_args_info_detailed_help[12] ;
  args_info->log_time_help = RNAdos_args_info_detailed_help[13] ;
  args_info->log_call_help = RNAdos_args_info_detailed_help[14] ;
  args_info->max_energy_help = RNAdos_args_info_detailed_help[17] ;
  args_info->hashtable_bits_help = RNAdos_args_info_detailed_help[18] ;
  args_info->temp_help = RNAdos_args_info_detailed_help[21] ;
  args_info->paramFile_help = RNAdos_args_info_detailed_help[22] ;
  args_info->salt_help = RNAdos_args_info_detailed_help[24] ;
  args_info->dangles_help = RNAdos_args_info_detailed_help[27] ;
  args_info->helical_rise_help = RNAdos_args_info_detailed_help[29] ;
  args_info->backbone_length_help = RNAdos_args_info_detailed_help[31] ;
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAdos.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
