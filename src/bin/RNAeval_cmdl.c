/*
  ...
  /usr/local/bin/gengetopt -i RNAeval.ggo --file-name=RNAeval_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAeval_cmdline_parser --arg-struct-name=RNAeval_args_info
...
init_full_help_array(void)
{
  ...
  RNAeval_args_info_full_help[5] = RNAeval_args_info_detailed_help[6];
  RNAeval_args_info_full_help[6] = RNAeval_args_info_detailed_help[7];
  RNAeval_args_info_full_help[7] = RNAeval_args_info_detailed_help[8];
  RNAeval_args_info_full_help[8] = RNAeval_args_info_detailed_help[10];
  RNAeval_args_info_full_help[9] = RNAeval_args_info_detailed_help[12];
  RNAeval_args_info_full_help[10] = RNAeval_args_info_detailed_help[13];
  RNAeval_args_info_full_help[11] = RNAeval_args_info_detailed_help[15];
  RNAeval_args_info_full_help[12] = RNAeval_args_info_detailed_help[17];
  ...
  RNAeval_args_info_full_help[18] = RNAeval_args_info_detailed_help[28];
  RNAeval_args_info_full_help[19] = RNAeval_args_info_detailed_help[30];
  RNAeval_args_info_full_help[20] = RNAeval_args_info_detailed_help[31];
  RNAeval_args_info_full_help[21] = RNAeval_args_info_detailed_help[32];
  RNAeval_args_info_full_help[22] = RNAeval_args_info_detailed_help[33];
  RNAeval_args_info_full_help[23] = RNAeval_args_info_detailed_help[34];
  RNAeval_args_info_full_help[24] = RNAeval_args_info_detailed_help[35];
  RNAeval_args_info_full_help[25] = RNAeval_args_info_detailed_help[36];
  ...
  RNAeval_args_info_full_help[30] = RNAeval_args_info_detailed_help[42];
  RNAeval_args_info_full_help[31] = RNAeval_args_info_detailed_help[44];
  ...
  RNAeval_args_info_full_help[35] = RNAeval_args_info_detailed_help[49];
  ...
  RNAeval_args_info_full_help[38] = RNAeval_args_info_detailed_help[53];
  RNAeval_args_info_full_help[39] = RNAeval_args_info_detailed_help[54];
  RNAeval_args_info_full_help[40] = RNAeval_args_info_detailed_help[56];
  ...
  RNAeval_args_info_full_help[45] = RNAeval_args_info_detailed_help[64];
  RNAeval_args_info_full_help[46] = RNAeval_args_info_detailed_help[66];
  RNAeval_args_info_full_help[47] = RNAeval_args_info_detailed_help[68];
  RNAeval_args_info_full_help[48] = RNAeval_args_info_detailed_help[69];
  RNAeval_args_info_full_help[49] = RNAeval_args_info_detailed_help[71];
  RNAeval_args_info_full_help[50] = RNAeval_args_info_detailed_help[73];
  RNAeval_args_info_full_help[51] = 0; 
  
}

const char *RNAeval_args_info_full_help[52];
...
init_help_array(void)
{
  ...
  RNAeval_args_info_help[5] = RNAeval_args_info_detailed_help[6];
  RNAeval_args_info_help[6] = RNAeval_args_info_detailed_help[7];
  RNAeval_args_info_help[7] = RNAeval_args_info_detailed_help[8];
  RNAeval_args_info_help[8] = RNAeval_args_info_detailed_help[10];
  RNAeval_args_info_help[9] = RNAeval_args_info_detailed_help[12];
  RNAeval_args_info_help[10] = RNAeval_args_info_detailed_help[13];
  ...
  RNAeval_args_info_help[14] = RNAeval_args_info_detailed_help[33];
  RNAeval_args_info_help[15] = RNAeval_args_info_detailed_help[34];
  RNAeval_args_info_help[16] = RNAeval_args_info_detailed_help[35];
  RNAeval_args_info_help[17] = RNAeval_args_info_detailed_help[36];
  RNAeval_args_info_help[18] = RNAeval_args_info_detailed_help[37];
  RNAeval_args_info_help[19] = RNAeval_args_info_detailed_help[38];
  RNAeval_args_info_help[20] = RNAeval_args_info_detailed_help[39];
  RNAeval_args_info_help[21] = RNAeval_args_info_detailed_help[42];
  RNAeval_args_info_help[22] = RNAeval_args_info_detailed_help[44];
  RNAeval_args_info_help[23] = RNAeval_args_info_detailed_help[45];
  RNAeval_args_info_help[24] = RNAeval_args_info_detailed_help[46];
  RNAeval_args_info_help[25] = RNAeval_args_info_detailed_help[47];
  RNAeval_args_info_help[26] = RNAeval_args_info_detailed_help[51];
  RNAeval_args_info_help[27] = RNAeval_args_info_detailed_help[52];
  RNAeval_args_info_help[28] = RNAeval_args_info_detailed_help[53];
  RNAeval_args_info_help[29] = RNAeval_args_info_detailed_help[54];
  RNAeval_args_info_help[30] = RNAeval_args_info_detailed_help[60];
  RNAeval_args_info_help[31] = RNAeval_args_info_detailed_help[62];
  RNAeval_args_info_help[32] = RNAeval_args_info_detailed_help[63];
  RNAeval_args_info_help[33] = RNAeval_args_info_detailed_help[64];
  RNAeval_args_info_help[34] = RNAeval_args_info_detailed_help[66];
  RNAeval_args_info_help[35] = RNAeval_args_info_detailed_help[68];
  RNAeval_args_info_help[36] = RNAeval_args_info_detailed_help[73];
...
void clear_args (struct RNAeval_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAeval.log");
...
void init_args_info(struct RNAeval_args_info *args_info)
{
  ...
  args_info->infile_help = RNAeval_args_info_detailed_help[8] ;
  args_info->infile_min = 0;
  args_info->infile_max = 0;
  args_info->msa_help = RNAeval_args_info_detailed_help[10] ;
  args_info->mis_help = RNAeval_args_info_detailed_help[12] ;
  args_info->jobs_help = RNAeval_args_info_detailed_help[13] ;
  args_info->unordered_help = RNAeval_args_info_detailed_help[15] ;
  args_info->noconv_help = RNAeval_args_info_detailed_help[17] ;
  args_info->auto_id_help = RNAeval_args_info_detailed_help[18] ;
  args_info->id_prefix_help = RNAeval_args_info_detailed_help[20] ;
  args_info->id_delim_help = RNAeval_args_info_detailed_help[22] ;
  args_info->id_digits_help = RNAeval_args_info_detailed_help[24] ;
  args_info->id_start_help = RNAeval_args_info_detailed_help[26] ;
  args_info->log_level_help = RNAeval_args_info_detailed_help[28] ;
  args_info->log_file_help = RNAeval_args_info_detailed_help[30] ;
  args_info->log_time_help = RNAeval_args_info_detailed_help[31] ;
  args_info->log_call_help = RNAeval_args_info_detailed_help[32] ;
  args_info->circ_help = RNAeval_args_info_detailed_help[35] ;
  args_info->gquad_help = RNAeval_args_info_detailed_help[36] ;
  args_info->shape_help = RNAeval_args_info_detailed_help[39] ;
  args_info->shapeMethod_help = RNAeval_args_info_detailed_help[40] ;
  args_info->shapeConversion_help = RNAeval_args_info_detailed_help[42] ;
  args_info->temp_help = RNAeval_args_info_detailed_help[46] ;
  args_info->paramFile_help = RNAeval_args_info_detailed_help[47] ;
  args_info->noTetra_help = RNAeval_args_info_detailed_help[49] ;
  args_info->salt_help = RNAeval_args_info_detailed_help[51] ;
  args_info->dangles_help = RNAeval_args_info_detailed_help[54] ;
  args_info->nsp_help = RNAeval_args_info_detailed_help[56] ;
  args_info->energyModel_help = RNAeval_args_info_detailed_help[58] ;
  args_info->logML_help = RNAeval_args_info_detailed_help[60] ;
  args_info->cfactor_help = RNAeval_args_info_detailed_help[62] ;
  args_info->nfactor_help = RNAeval_args_info_detailed_help[63] ;
  args_info->ribosum_file_help = RNAeval_args_info_detailed_help[64] ;
  args_info->ribosum_scoring_help = RNAeval_args_info_detailed_help[66] ;
  args_info->old_help = RNAeval_args_info_detailed_help[68] ;
  args_info->helical_rise_help = RNAeval_args_info_detailed_help[69] ;
  args_info->backbone_length_help = RNAeval_args_info_detailed_help[71] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvi:aj::cgT:P:4d:R:r", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'v':	/* Be verbose and print out energy contribution of each loop in the structure.
.  */
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAeval.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
