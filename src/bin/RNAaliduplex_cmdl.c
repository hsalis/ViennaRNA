/*
  ...
  /usr/local/bin/gengetopt -i RNAaliduplex.ggo --file-name=RNAaliduplex_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAaliduplex_cmdline_parser --arg-struct-name=RNAaliduplex_args_info
...
init_full_help_array(void)
{
  ...
  RNAaliduplex_args_info_full_help[5] = RNAaliduplex_args_info_detailed_help[6];
  RNAaliduplex_args_info_full_help[6] = RNAaliduplex_args_info_detailed_help[7];
  RNAaliduplex_args_info_full_help[7] = RNAaliduplex_args_info_detailed_help[8];
  RNAaliduplex_args_info_full_help[8] = RNAaliduplex_args_info_detailed_help[9];
  RNAaliduplex_args_info_full_help[9] = RNAaliduplex_args_info_detailed_help[10];
  RNAaliduplex_args_info_full_help[10] = RNAaliduplex_args_info_detailed_help[11];
  RNAaliduplex_args_info_full_help[11] = RNAaliduplex_args_info_detailed_help[12];
  ...
  RNAaliduplex_args_info_full_help[14] = RNAaliduplex_args_info_detailed_help[17];
  RNAaliduplex_args_info_full_help[15] = RNAaliduplex_args_info_detailed_help[18];
  RNAaliduplex_args_info_full_help[16] = RNAaliduplex_args_info_detailed_help[19];
  RNAaliduplex_args_info_full_help[17] = RNAaliduplex_args_info_detailed_help[20];
  ...
  RNAaliduplex_args_info_full_help[20] = RNAaliduplex_args_info_detailed_help[25];
  RNAaliduplex_args_info_full_help[21] = RNAaliduplex_args_info_detailed_help[26];
  ...
  RNAaliduplex_args_info_full_help[25] = RNAaliduplex_args_info_detailed_help[33];
  RNAaliduplex_args_info_full_help[26] = RNAaliduplex_args_info_detailed_help[35];
  RNAaliduplex_args_info_full_help[27] = RNAaliduplex_args_info_detailed_help[36];
  RNAaliduplex_args_info_full_help[28] = RNAaliduplex_args_info_detailed_help[37];
  RNAaliduplex_args_info_full_help[29] = RNAaliduplex_args_info_detailed_help[38];
  RNAaliduplex_args_info_full_help[30] = 0; 
  
}

const char *RNAaliduplex_args_info_full_help[31];
...
init_help_array(void)
{
  ...
  RNAaliduplex_args_info_help[5] = RNAaliduplex_args_info_detailed_help[6];
  RNAaliduplex_args_info_help[6] = RNAaliduplex_args_info_detailed_help[7];
  RNAaliduplex_args_info_help[7] = RNAaliduplex_args_info_detailed_help[8];
  RNAaliduplex_args_info_help[8] = RNAaliduplex_args_info_detailed_help[9];
  RNAaliduplex_args_info_help[9] = RNAaliduplex_args_info_detailed_help[10];
  RNAaliduplex_args_info_help[10] = RNAaliduplex_args_info_detailed_help[11];
  ...
  RNAaliduplex_args_info_help[14] = RNAaliduplex_args_info_detailed_help[19];
  RNAaliduplex_args_info_help[15] = RNAaliduplex_args_info_detailed_help[20];
  RNAaliduplex_args_info_help[16] = RNAaliduplex_args_info_detailed_help[21];
  RNAaliduplex_args_info_help[17] = RNAaliduplex_args_info_detailed_help[23];
  RNAaliduplex_args_info_help[18] = RNAaliduplex_args_info_detailed_help[38];
...
void clear_args (struct RNAaliduplex_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAaliduplex.log");
...
void init_args_info(struct RNAaliduplex_args_info *args_info)
{
  ...
  args_info->verbose_help = RNAaliduplex_args_info_detailed_help[4] ;
  args_info->deltaEnergy_help = RNAaliduplex_args_info_detailed_help[8] ;
  args_info->sorted_help = RNAaliduplex_args_info_detailed_help[9] ;
  args_info->temp_help = RNAaliduplex_args_info_detailed_help[12] ;
  args_info->paramFile_help = RNAaliduplex_args_info_detailed_help[13] ;
  args_info->noTetra_help = RNAaliduplex_args_info_detailed_help[15] ;
  ...
  args_info->dangles_help = RNAaliduplex_args_info_detailed_help[21] ;
  args_info->noLP_help = RNAaliduplex_args_info_detailed_help[23] ;
  args_info->noGU_help = RNAaliduplex_args_info_detailed_help[25] ;
  args_info->noClosingGU_help = RNAaliduplex_args_info_detailed_help[26] ;
  args_info->nsp_help = RNAaliduplex_args_info_detailed_help[27] ;
  args_info->helical_rise_help = RNAaliduplex_args_info_detailed_help[29] ;
  args_info->backbone_length_help = RNAaliduplex_args_info_detailed_help[31] ;
  args_info->log_level_help = RNAaliduplex_args_info_detailed_help[33] ;
  args_info->log_file_help = RNAaliduplex_args_info_detailed_help[35] ;
  args_info->log_time_help = RNAaliduplex_args_info_detailed_help[36] ;
  args_info->log_call_help = RNAaliduplex_args_info_detailed_help[37] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVve:sT:P:4d:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAaliduplex.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
