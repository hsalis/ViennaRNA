/*
  ...
  /usr/local/bin/gengetopt -i RNAplex.ggo --file-name=RNAplex_cmdl --include-getopt --default-optional --func-name=RNAplex_cmdline_parser --arg-struct-name=RNAplex_args_info
...
init_full_help_array(void)
{
  ...
  RNAplex_args_info_full_help[5] = RNAplex_args_info_detailed_help[6];
  RNAplex_args_info_full_help[6] = RNAplex_args_info_detailed_help[7];
  ...
  RNAplex_args_info_full_help[12] = RNAplex_args_info_detailed_help[18];
  RNAplex_args_info_full_help[13] = RNAplex_args_info_detailed_help[19];
  ...
  RNAplex_args_info_full_help[16] = RNAplex_args_info_detailed_help[22];
  RNAplex_args_info_full_help[17] = RNAplex_args_info_detailed_help[23];
  ...
  RNAplex_args_info_full_help[20] = RNAplex_args_info_detailed_help[29];
  RNAplex_args_info_full_help[21] = RNAplex_args_info_detailed_help[30];
  RNAplex_args_info_full_help[22] = RNAplex_args_info_detailed_help[31];
  RNAplex_args_info_full_help[23] = RNAplex_args_info_detailed_help[32];
  RNAplex_args_info_full_help[24] = RNAplex_args_info_detailed_help[33];
  ...
  RNAplex_args_info_full_help[30] = RNAplex_args_info_detailed_help[44];
  RNAplex_args_info_full_help[31] = RNAplex_args_info_detailed_help[46];
  RNAplex_args_info_full_help[32] = RNAplex_args_info_detailed_help[48];
  RNAplex_args_info_full_help[33] = RNAplex_args_info_detailed_help[49];
  ...
  RNAplex_args_info_full_help[39] = RNAplex_args_info_detailed_help[57];
  RNAplex_args_info_full_help[40] = RNAplex_args_info_detailed_help[59];
  ...
  RNAplex_args_info_full_help[44] = RNAplex_args_info_detailed_help[63];
  RNAplex_args_info_full_help[45] = RNAplex_args_info_detailed_help[65];
  RNAplex_args_info_full_help[46] = RNAplex_args_info_detailed_help[67];
  RNAplex_args_info_full_help[47] = RNAplex_args_info_detailed_help[68];
  RNAplex_args_info_full_help[48] = RNAplex_args_info_detailed_help[69];
  RNAplex_args_info_full_help[49] = RNAplex_args_info_detailed_help[71];
  RNAplex_args_info_full_help[50] = 0; 
  
}

const char *RNAplex_args_info_full_help[51];
...
init_help_array(void)
{
  ...
  RNAplex_args_info_help[5] = RNAplex_args_info_detailed_help[6];
  ...
  RNAplex_args_info_help[11] = RNAplex_args_info_detailed_help[21];
  RNAplex_args_info_help[12] = RNAplex_args_info_detailed_help[22];
  RNAplex_args_info_help[13] = RNAplex_args_info_detailed_help[23];
  RNAplex_args_info_help[14] = RNAplex_args_info_detailed_help[25];
  RNAplex_args_info_help[15] = RNAplex_args_info_detailed_help[27];
  RNAplex_args_info_help[16] = RNAplex_args_info_detailed_help[29];
  RNAplex_args_info_help[17] = RNAplex_args_info_detailed_help[34];
  RNAplex_args_info_help[18] = RNAplex_args_info_detailed_help[36];
  RNAplex_args_info_help[19] = RNAplex_args_info_detailed_help[38];
  RNAplex_args_info_help[20] = RNAplex_args_info_detailed_help[40];
  RNAplex_args_info_help[21] = RNAplex_args_info_detailed_help[42];
  RNAplex_args_info_help[22] = RNAplex_args_info_detailed_help[44];
  RNAplex_args_info_help[23] = RNAplex_args_info_detailed_help[46];
  RNAplex_args_info_help[24] = RNAplex_args_info_detailed_help[48];
  RNAplex_args_info_help[25] = RNAplex_args_info_detailed_help[49];
  RNAplex_args_info_help[26] = RNAplex_args_info_detailed_help[50];
  RNAplex_args_info_help[27] = RNAplex_args_info_detailed_help[52];
  RNAplex_args_info_help[28] = RNAplex_args_info_detailed_help[53];
  RNAplex_args_info_help[29] = RNAplex_args_info_detailed_help[54];
  RNAplex_args_info_help[30] = RNAplex_args_info_detailed_help[55];
  RNAplex_args_info_help[31] = RNAplex_args_info_detailed_help[59];
  RNAplex_args_info_help[32] = RNAplex_args_info_detailed_help[67];
  RNAplex_args_info_help[33] = RNAplex_args_info_detailed_help[68];
  RNAplex_args_info_help[34] = RNAplex_args_info_detailed_help[69];
  RNAplex_args_info_help[35] = RNAplex_args_info_detailed_help[71];
  RNAplex_args_info_help[36] = 0; 
  
}

const char *RNAplex_args_info_help[37];
...
void clear_args (struct RNAplex_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAplex.log");
...
void init_args_info(struct RNAplex_args_info *args_info)
{
  ...
  args_info->verbose_help = RNAplex_args_info_detailed_help[4] ;
  args_info->query_help = RNAplex_args_info_detailed_help[8] ;
  args_info->target_help = RNAplex_args_info_detailed_help[10] ;
  args_info->accessibility_dir_help = RNAplex_args_info_detailed_help[12] ;
  args_info->binary_help = RNAplex_args_info_detailed_help[14] ;
  args_info->log_level_help = RNAplex_args_info_detailed_help[16] ;
  args_info->log_file_help = RNAplex_args_info_detailed_help[18] ;
  args_info->log_time_help = RNAplex_args_info_detailed_help[19] ;
  args_info->log_call_help = RNAplex_args_info_detailed_help[20] ;
  args_info->interaction_length_help = RNAplex_args_info_detailed_help[23] ;
  args_info->extension_cost_help = RNAplex_args_info_detailed_help[25] ;
  args_info->probe_mode_help = RNAplex_args_info_detailed_help[27] ;
  args_info->probe_concentration_help = RNAplex_args_info_detailed_help[29] ;
  args_info->na_concentration_help = RNAplex_args_info_detailed_help[30] ;
  args_info->mg_concentration_help = RNAplex_args_info_detailed_help[31] ;
  args_info->k_concentration_help = RNAplex_args_info_detailed_help[32] ;
  args_info->tris_concentration_help = RNAplex_args_info_detailed_help[33] ;
  args_info->fast_folding_help = RNAplex_args_info_detailed_help[34] ;
  args_info->scale_accessibility_help = RNAplex_args_info_detailed_help[36] ;
  ...
  args_info->duplex_distance_help = RNAplex_args_info_detailed_help[42] ;
  args_info->energy_threshold_help = RNAplex_args_info_detailed_help[44] ;
  args_info->WindowLength_help = RNAplex_args_info_detailed_help[46] ;
  args_info->constraint_help = RNAplex_args_info_detailed_help[50] ;
  args_info->temp_help = RNAplex_args_info_detailed_help[54] ;
  args_info->paramFile_help = RNAplex_args_info_detailed_help[55] ;
  args_info->noTetra_help = RNAplex_args_info_detailed_help[57] ;
  args_info->salt_help = RNAplex_args_info_detailed_help[59] ;
  args_info->saltInit_help = RNAplex_args_info_detailed_help[60] ;
  args_info->helical_rise_help = RNAplex_args_info_detailed_help[63] ;
  args_info->backbone_length_help = RNAplex_args_info_detailed_help[65] ;
  args_info->produce_ps_help = RNAplex_args_info_detailed_help[69] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hvq:t:a:bl:c:pQ:N:M:K:U:f:V:Akz:e:L:CT:P:4I:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAplex.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
