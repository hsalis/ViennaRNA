/*
  ...
  /usr/local/bin/gengetopt -i RNAalifold.ggo --file-name=RNAalifold_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAalifold_cmdline_parser --arg-struct-name=RNAalifold_args_info
...
const char *RNAalifold_args_info_detailed_help[] = {
  ...
  "      --log-file[=filename]     Print log messages to a file instead of stderr.\n                                    (default=`RNAalifold.log')",
  "      --log-time                Include time stamp in log messages.\n\n                                    (default=off)",
  "      --log-call                Include file and line of log calling function.\n\n                                    (default=off)",
  "      --benchmark               Perform a prediction performance test\n                                  (benchmark) based on reference structures\n                                  taken from the input.\n\n                                    (default=off)",
  "      --bm-output=filename      Store the performance benchmark results in a\n                                  file.\n\n",
  "      --bm-output-append        Append performance benchmark data to a file\n                                  instead of overwriting already existing\n                                  content.\n\n                                    (default=off)",
  "      --bm-rm-pk                Remove pseudo-knots from the reference\n                                  structure before computing benchmark.\n\n                                    (default=off)",
  "\nAlgorithms:",
  ...
  "      --color-threshold=FLOAT   Set the threshold of maximum counter examples\n                                  for coloring consensus structure plot.\n                                    (default=`2')",
  ...
  "      --color-min-sat=FLOAT     Set the minimum saturation for coloring\n                                  consensus structure plot.\n                                    (default=`0.2')",
...
init_full_help_array(void)
{
  ...
  RNAalifold_args_info_full_help[5] = RNAalifold_args_info_detailed_help[6];
  RNAalifold_args_info_full_help[6] = RNAalifold_args_info_detailed_help[8];
  RNAalifold_args_info_full_help[7] = RNAalifold_args_info_detailed_help[9];
  RNAalifold_args_info_full_help[8] = RNAalifold_args_info_detailed_help[10];
  RNAalifold_args_info_full_help[9] = RNAalifold_args_info_detailed_help[12];
  RNAalifold_args_info_full_help[10] = RNAalifold_args_info_detailed_help[13];
  RNAalifold_args_info_full_help[11] = RNAalifold_args_info_detailed_help[15];
  RNAalifold_args_info_full_help[12] = RNAalifold_args_info_detailed_help[17];
  RNAalifold_args_info_full_help[13] = RNAalifold_args_info_detailed_help[18];
  RNAalifold_args_info_full_help[14] = RNAalifold_args_info_detailed_help[20];
  RNAalifold_args_info_full_help[15] = RNAalifold_args_info_detailed_help[22];
  RNAalifold_args_info_full_help[16] = RNAalifold_args_info_detailed_help[24];
  RNAalifold_args_info_full_help[17] = RNAalifold_args_info_detailed_help[26];
  RNAalifold_args_info_full_help[18] = RNAalifold_args_info_detailed_help[28];
  RNAalifold_args_info_full_help[19] = RNAalifold_args_info_detailed_help[30];
  RNAalifold_args_info_full_help[20] = RNAalifold_args_info_detailed_help[32];
  RNAalifold_args_info_full_help[21] = RNAalifold_args_info_detailed_help[34];
  RNAalifold_args_info_full_help[22] = RNAalifold_args_info_detailed_help[35];
  RNAalifold_args_info_full_help[23] = RNAalifold_args_info_detailed_help[36];
  ...
  RNAalifold_args_info_full_help[26] = RNAalifold_args_info_detailed_help[39];
  RNAalifold_args_info_full_help[27] = RNAalifold_args_info_detailed_help[40];
  RNAalifold_args_info_full_help[28] = RNAalifold_args_info_detailed_help[41];
  RNAalifold_args_info_full_help[29] = RNAalifold_args_info_detailed_help[42];
  RNAalifold_args_info_full_help[30] = RNAalifold_args_info_detailed_help[43];
  RNAalifold_args_info_full_help[31] = RNAalifold_args_info_detailed_help[45];
  RNAalifold_args_info_full_help[32] = RNAalifold_args_info_detailed_help[47];
  RNAalifold_args_info_full_help[33] = RNAalifold_args_info_detailed_help[49];
  RNAalifold_args_info_full_help[34] = RNAalifold_args_info_detailed_help[51];
  RNAalifold_args_info_full_help[35] = RNAalifold_args_info_detailed_help[52];
  RNAalifold_args_info_full_help[36] = RNAalifold_args_info_detailed_help[53];
  RNAalifold_args_info_full_help[37] = RNAalifold_args_info_detailed_help[55];
  ...
  RNAalifold_args_info_full_help[40] = RNAalifold_args_info_detailed_help[58];
  RNAalifold_args_info_full_help[41] = RNAalifold_args_info_detailed_help[59];
  RNAalifold_args_info_full_help[42] = RNAalifold_args_info_detailed_help[60];
  ...
  RNAalifold_args_info_full_help[46] = RNAalifold_args_info_detailed_help[65];
  RNAalifold_args_info_full_help[47] = RNAalifold_args_info_detailed_help[67];
  RNAalifold_args_info_full_help[48] = RNAalifold_args_info_detailed_help[68];
  RNAalifold_args_info_full_help[49] = RNAalifold_args_info_detailed_help[70];
  RNAalifold_args_info_full_help[50] = RNAalifold_args_info_detailed_help[72];
  RNAalifold_args_info_full_help[51] = RNAalifold_args_info_detailed_help[74];
  RNAalifold_args_info_full_help[52] = RNAalifold_args_info_detailed_help[75];
  RNAalifold_args_info_full_help[53] = RNAalifold_args_info_detailed_help[76];
  RNAalifold_args_info_full_help[54] = RNAalifold_args_info_detailed_help[77];
  RNAalifold_args_info_full_help[55] = RNAalifold_args_info_detailed_help[79];
  ...
  RNAalifold_args_info_full_help[58] = RNAalifold_args_info_detailed_help[83];
  RNAalifold_args_info_full_help[59] = RNAalifold_args_info_detailed_help[84];
  RNAalifold_args_info_full_help[60] = RNAalifold_args_info_detailed_help[86];
  RNAalifold_args_info_full_help[61] = RNAalifold_args_info_detailed_help[88];
  ...
  RNAalifold_args_info_full_help[64] = RNAalifold_args_info_detailed_help[91];
  RNAalifold_args_info_full_help[65] = RNAalifold_args_info_detailed_help[92];
  RNAalifold_args_info_full_help[66] = RNAalifold_args_info_detailed_help[93];
  RNAalifold_args_info_full_help[67] = RNAalifold_args_info_detailed_help[95];
  RNAalifold_args_info_full_help[68] = RNAalifold_args_info_detailed_help[97];
  RNAalifold_args_info_full_help[69] = RNAalifold_args_info_detailed_help[98];
  RNAalifold_args_info_full_help[70] = RNAalifold_args_info_detailed_help[100];
  RNAalifold_args_info_full_help[71] = RNAalifold_args_info_detailed_help[102];
  RNAalifold_args_info_full_help[72] = RNAalifold_args_info_detailed_help[104];
  RNAalifold_args_info_full_help[73] = RNAalifold_args_info_detailed_help[106];
  RNAalifold_args_info_full_help[74] = RNAalifold_args_info_detailed_help[107];
  RNAalifold_args_info_full_help[75] = RNAalifold_args_info_detailed_help[108];
  RNAalifold_args_info_full_help[76] = RNAalifold_args_info_detailed_help[109];
  RNAalifold_args_info_full_help[77] = RNAalifold_args_info_detailed_help[111];
  RNAalifold_args_info_full_help[78] = RNAalifold_args_info_detailed_help[113];
  RNAalifold_args_info_full_help[79] = RNAalifold_args_info_detailed_help[114];
  RNAalifold_args_info_full_help[80] = RNAalifold_args_info_detailed_help[116];
  RNAalifold_args_info_full_help[81] = RNAalifold_args_info_detailed_help[118];
  RNAalifold_args_info_full_help[82] = RNAalifold_args_info_detailed_help[119];
  RNAalifold_args_info_full_help[83] = RNAalifold_args_info_detailed_help[121];
  RNAalifold_args_info_full_help[84] = RNAalifold_args_info_detailed_help[123];
  RNAalifold_args_info_full_help[85] = 0; 
  
}

const char *RNAalifold_args_info_full_help[86];
...
init_help_array(void)
{
  ...
  RNAalifold_args_info_help[5] = RNAalifold_args_info_detailed_help[6];
  RNAalifold_args_info_help[6] = RNAalifold_args_info_detailed_help[8];
  RNAalifold_args_info_help[7] = RNAalifold_args_info_detailed_help[9];
  RNAalifold_args_info_help[8] = RNAalifold_args_info_detailed_help[10];
  RNAalifold_args_info_help[9] = RNAalifold_args_info_detailed_help[12];
  RNAalifold_args_info_help[10] = RNAalifold_args_info_detailed_help[13];
  RNAalifold_args_info_help[11] = RNAalifold_args_info_detailed_help[17];
  RNAalifold_args_info_help[12] = RNAalifold_args_info_detailed_help[18];
  RNAalifold_args_info_help[13] = RNAalifold_args_info_detailed_help[20];
  RNAalifold_args_info_help[14] = RNAalifold_args_info_detailed_help[22];
  RNAalifold_args_info_help[15] = RNAalifold_args_info_detailed_help[41];
  RNAalifold_args_info_help[16] = RNAalifold_args_info_detailed_help[42];
  RNAalifold_args_info_help[17] = RNAalifold_args_info_detailed_help[43];
  RNAalifold_args_info_help[18] = RNAalifold_args_info_detailed_help[49];
  RNAalifold_args_info_help[19] = RNAalifold_args_info_detailed_help[51];
  RNAalifold_args_info_help[20] = RNAalifold_args_info_detailed_help[52];
  RNAalifold_args_info_help[21] = RNAalifold_args_info_detailed_help[55];
  RNAalifold_args_info_help[22] = RNAalifold_args_info_detailed_help[56];
  RNAalifold_args_info_help[23] = RNAalifold_args_info_detailed_help[57];
  RNAalifold_args_info_help[24] = RNAalifold_args_info_detailed_help[58];
  RNAalifold_args_info_help[25] = RNAalifold_args_info_detailed_help[60];
  RNAalifold_args_info_help[26] = RNAalifold_args_info_detailed_help[61];
  RNAalifold_args_info_help[27] = RNAalifold_args_info_detailed_help[62];
  RNAalifold_args_info_help[28] = RNAalifold_args_info_detailed_help[63];
  RNAalifold_args_info_help[29] = RNAalifold_args_info_detailed_help[67];
  RNAalifold_args_info_help[30] = RNAalifold_args_info_detailed_help[68];
  RNAalifold_args_info_help[31] = RNAalifold_args_info_detailed_help[70];
  RNAalifold_args_info_help[32] = RNAalifold_args_info_detailed_help[74];
  RNAalifold_args_info_help[33] = RNAalifold_args_info_detailed_help[75];
  RNAalifold_args_info_help[34] = RNAalifold_args_info_detailed_help[76];
  RNAalifold_args_info_help[35] = RNAalifold_args_info_detailed_help[77];
  RNAalifold_args_info_help[36] = RNAalifold_args_info_detailed_help[81];
  RNAalifold_args_info_help[37] = RNAalifold_args_info_detailed_help[82];
  RNAalifold_args_info_help[38] = RNAalifold_args_info_detailed_help[83];
  RNAalifold_args_info_help[39] = RNAalifold_args_info_detailed_help[84];
  RNAalifold_args_info_help[40] = RNAalifold_args_info_detailed_help[86];
  RNAalifold_args_info_help[41] = RNAalifold_args_info_detailed_help[90];
  RNAalifold_args_info_help[42] = RNAalifold_args_info_detailed_help[91];
  RNAalifold_args_info_help[43] = RNAalifold_args_info_detailed_help[92];
  RNAalifold_args_info_help[44] = RNAalifold_args_info_detailed_help[93];
  RNAalifold_args_info_help[45] = RNAalifold_args_info_detailed_help[95];
  RNAalifold_args_info_help[46] = RNAalifold_args_info_detailed_help[97];
  RNAalifold_args_info_help[47] = RNAalifold_args_info_detailed_help[106];
  RNAalifold_args_info_help[48] = RNAalifold_args_info_detailed_help[107];
  RNAalifold_args_info_help[49] = RNAalifold_args_info_detailed_help[108];
  RNAalifold_args_info_help[50] = RNAalifold_args_info_detailed_help[113];
  RNAalifold_args_info_help[51] = RNAalifold_args_info_detailed_help[116];
  RNAalifold_args_info_help[52] = RNAalifold_args_info_detailed_help[118];
  RNAalifold_args_info_help[53] = RNAalifold_args_info_detailed_help[119];
  RNAalifold_args_info_help[54] = RNAalifold_args_info_detailed_help[123];
...
void clear_given (struct RNAalifold_args_info *args_info)
{
  ...
  args_info->bm_output_given = 0 ;
  args_info->bm_output_append_given = 0 ;
  args_info->bm_rm_pk_given = 0 ;
  ...
  args_info->color_threshold_given = 0 ;
  args_info->color_min_sat_given = 0 ;
...
void clear_args (struct RNAalifold_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAalifold.log");
  args_info->log_file_orig = NULL;
  args_info->log_time_flag = 0;
  args_info->log_call_flag = 0;
  args_info->benchmark_flag = 0;
  args_info->bm_output_arg = NULL;
  args_info->bm_output_orig = NULL;
  args_info->bm_output_append_flag = 0;
  args_info->bm_rm_pk_flag = 0;
  ...
  args_info->color_threshold_arg = 2;
  args_info->color_threshold_orig = NULL;
  args_info->color_min_sat_arg = 0.2;
  args_info->color_min_sat_orig = NULL;
...
void init_args_info(struct RNAalifold_args_info *args_info)
{
  ...
  args_info->quiet_help = RNAalifold_args_info_detailed_help[6] ;
  args_info->input_format_help = RNAalifold_args_info_detailed_help[10] ;
  args_info->mis_help = RNAalifold_args_info_detailed_help[12] ;
  args_info->jobs_help = RNAalifold_args_info_detailed_help[13] ;
  args_info->unordered_help = RNAalifold_args_info_detailed_help[15] ;
  args_info->noconv_help = RNAalifold_args_info_detailed_help[17] ;
  args_info->continuous_ids_help = RNAalifold_args_info_detailed_help[18] ;
  args_info->auto_id_help = RNAalifold_args_info_detailed_help[20] ;
  args_info->id_prefix_help = RNAalifold_args_info_detailed_help[22] ;
  args_info->id_delim_help = RNAalifold_args_info_detailed_help[24] ;
  args_info->id_digits_help = RNAalifold_args_info_detailed_help[26] ;
  args_info->id_start_help = RNAalifold_args_info_detailed_help[28] ;
  args_info->filename_delim_help = RNAalifold_args_info_detailed_help[30] ;
  args_info->log_level_help = RNAalifold_args_info_detailed_help[32] ;
  args_info->log_file_help = RNAalifold_args_info_detailed_help[34] ;
  args_info->log_time_help = RNAalifold_args_info_detailed_help[35] ;
  args_info->log_call_help = RNAalifold_args_info_detailed_help[36] ;
  args_info->benchmark_help = RNAalifold_args_info_detailed_help[37] ;
  args_info->bm_output_help = RNAalifold_args_info_detailed_help[38] ;
  args_info->bm_output_append_help = RNAalifold_args_info_detailed_help[39] ;
  args_info->bm_rm_pk_help = RNAalifold_args_info_detailed_help[40] ;
  args_info->partfunc_help = RNAalifold_args_info_detailed_help[43] ;
  args_info->betaScale_help = RNAalifold_args_info_detailed_help[45] ;
  args_info->pfScale_help = RNAalifold_args_info_detailed_help[47] ;
  args_info->MEA_help = RNAalifold_args_info_detailed_help[49] ;
  args_info->sci_help = RNAalifold_args_info_detailed_help[51] ;
  args_info->circ_help = RNAalifold_args_info_detailed_help[52] ;
  args_info->bppmThreshold_help = RNAalifold_args_info_detailed_help[53] ;
  args_info->gquad_help = RNAalifold_args_info_detailed_help[55] ;
  args_info->stochBT_help = RNAalifold_args_info_detailed_help[56] ;
  args_info->stochBT_en_help = RNAalifold_args_info_detailed_help[57] ;
  args_info->nonRedundant_help = RNAalifold_args_info_detailed_help[58] ;
  args_info->random_seed_help = RNAalifold_args_info_detailed_help[59] ;
  args_info->maxBPspan_help = RNAalifold_args_info_detailed_help[62] ;
  args_info->constraint_help = RNAalifold_args_info_detailed_help[63] ;
  args_info->batch_help = RNAalifold_args_info_detailed_help[65] ;
  args_info->enforceConstraint_help = RNAalifold_args_info_detailed_help[67] ;
  args_info->SS_cons_help = RNAalifold_args_info_detailed_help[68] ;
  args_info->shape_help = RNAalifold_args_info_detailed_help[70] ;
  args_info->shape_min = 1;
  args_info->shape_max = 0;
  args_info->shapeMethod_help = RNAalifold_args_info_detailed_help[72] ;
  args_info->temp_help = RNAalifold_args_info_detailed_help[76] ;
  args_info->paramFile_help = RNAalifold_args_info_detailed_help[77] ;
  args_info->noTetra_help = RNAalifold_args_info_detailed_help[79] ;
  args_info->salt_help = RNAalifold_args_info_detailed_help[81] ;
  args_info->dangles_help = RNAalifold_args_info_detailed_help[84] ;
  args_info->noLP_help = RNAalifold_args_info_detailed_help[86] ;
  args_info->noGU_help = RNAalifold_args_info_detailed_help[88] ;
  args_info->noClosingGU_help = RNAalifold_args_info_detailed_help[89] ;
  args_info->cfactor_help = RNAalifold_args_info_detailed_help[90] ;
  args_info->nfactor_help = RNAalifold_args_info_detailed_help[91] ;
  args_info->endgaps_help = RNAalifold_args_info_detailed_help[92] ;
  args_info->ribosum_file_help = RNAalifold_args_info_detailed_help[93] ;
  args_info->ribosum_scoring_help = RNAalifold_args_info_detailed_help[95] ;
  args_info->old_help = RNAalifold_args_info_detailed_help[97] ;
  args_info->nsp_help = RNAalifold_args_info_detailed_help[98] ;
  args_info->energyModel_help = RNAalifold_args_info_detailed_help[100] ;
  args_info->helical_rise_help = RNAalifold_args_info_detailed_help[102] ;
  args_info->backbone_length_help = RNAalifold_args_info_detailed_help[104] ;
  args_info->color_help = RNAalifold_args_info_detailed_help[108] ;
  args_info->color_threshold_help = RNAalifold_args_info_detailed_help[109] ;
  args_info->color_min_sat_help = RNAalifold_args_info_detailed_help[111] ;
  args_info->aln_help = RNAalifold_args_info_detailed_help[113] ;
  args_info->aln_EPS_cols_help = RNAalifold_args_info_detailed_help[114] ;
  args_info->aln_stk_help = RNAalifold_args_info_detailed_help[116] ;
  args_info->noPS_help = RNAalifold_args_info_detailed_help[118] ;
  args_info->noDP_help = RNAalifold_args_info_detailed_help[119] ;
  args_info->layout_type_help = RNAalifold_args_info_detailed_help[121] ;
...
RNAalifold_cmdline_parser_release (struct RNAalifold_args_info *args_info)
{
  ...
  free_string_field (&(args_info->bm_output_arg));
  free_string_field (&(args_info->bm_output_orig));
  ...
  free_string_field (&(args_info->color_threshold_orig));
  free_string_field (&(args_info->color_min_sat_orig));
...
RNAalifold_cmdline_parser_dump(FILE *outfile, struct RNAalifold_args_info *args_info)
{
  ...
  if (args_info->bm_output_given)
    write_into_file(outfile, "bm-output", args_info->bm_output_orig, 0);
  if (args_info->bm_output_append_given)
    write_into_file(outfile, "bm-output-append", 0, 0 );
  if (args_info->bm_rm_pk_given)
    write_into_file(outfile, "bm-rm-pk", 0, 0 );
  ...
  if (args_info->color_threshold_given)
    write_into_file(outfile, "color-threshold", args_info->color_threshold_orig, 0);
  if (args_info->color_min_sat_given)
    write_into_file(outfile, "color-min-sat", args_info->color_min_sat_orig, 0);
...
RNAalifold_cmdline_parser_required2 (struct RNAalifold_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->bm_output_append_given && ! args_info->bm_output_given)
    {
      fprintf (stderr, "%s: '--bm-output-append' option depends on option 'bm-output'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "color",	0, NULL, 0 },
        { "color-threshold",	1, NULL, 0 },
        { "color-min-sat",	1, NULL, 0 },
        { "aln",	0, NULL, 0 },
      ...
      c = custom_getopt_long (argc, argv, "hVvqf:j::np::S:cgs:NC::T:P:4d:ER:rt:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAalifold.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
...
.  */
          ...
          /* Perform a prediction performance test (benchmark) based on reference structures taken from the input.
...
.  */
          else if (strcmp (long_options[option_index].name, "benchmark") == 0)
          {
            ...
            if (update_arg((void *)&(args_info->benchmark_flag), 0, &(args_info->benchmark_given),
                ...
                check_ambiguity, override, 1, 0, "benchmark", '-',
                additional_error))
              goto failure;
          
          }
          /* Store the performance benchmark results in a file.
          
.  */
          else if (strcmp (long_options[option_index].name, "bm-output") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->bm_output_arg), 
                 &(args_info->bm_output_orig), &(args_info->bm_output_given),
                &(local_args_info.bm_output_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "bm-output", '-',
                additional_error))
              goto failure;
          ...
          /* Append performance benchmark data to a file instead of overwriting already existing content.
          
.  */
          else if (strcmp (long_options[option_index].name, "bm-output-append") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->bm_output_append_flag), 0, &(args_info->bm_output_append_given),
                &(local_args_info.bm_output_append_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "bm-output-append", '-',
                additional_error))
              goto failure;
          
          }
          /* Remove pseudo-knots from the reference structure before computing benchmark.
          
.  */
          else if (strcmp (long_options[option_index].name, "bm-rm-pk") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->bm_rm_pk_flag), 0, &(args_info->bm_rm_pk_given),
                &(local_args_info.bm_rm_pk_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "bm-rm-pk", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "color-threshold") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->color_threshold_arg), 
                 &(args_info->color_threshold_orig), &(args_info->color_threshold_given),
                &(local_args_info.color_threshold_given), optarg, 0, "2", ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "color-threshold", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "color-min-sat") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->color_min_sat_arg), 
                 &(args_info->color_min_sat_orig), &(args_info->color_min_sat_given),
                &(local_args_info.color_min_sat_given), optarg, 0, "0.2", ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "color-min-sat", '-',
                additional_error))
              goto failure;
