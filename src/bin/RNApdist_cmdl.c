/*
  ...
  /usr/local/bin/gengetopt -i RNApdist.ggo --file-name=RNApdist_cmdl --include-getopt --default-optional --func-name=RNApdist_cmdline_parser --arg-struct-name=RNApdist_args_info
...
init_full_help_array(void)
{
  ...
  RNApdist_args_info_full_help[5] = RNApdist_args_info_detailed_help[6];
  RNApdist_args_info_full_help[6] = RNApdist_args_info_detailed_help[7];
  RNApdist_args_info_full_help[7] = RNApdist_args_info_detailed_help[8];
  ...
  RNApdist_args_info_full_help[21] = RNApdist_args_info_detailed_help[27];
  RNApdist_args_info_full_help[22] = RNApdist_args_info_detailed_help[28];
  RNApdist_args_info_full_help[23] = RNApdist_args_info_detailed_help[29];
  RNApdist_args_info_full_help[24] = RNApdist_args_info_detailed_help[30];
  RNApdist_args_info_full_help[25] = RNApdist_args_info_detailed_help[31];
  RNApdist_args_info_full_help[26] = RNApdist_args_info_detailed_help[33];
  RNApdist_args_info_full_help[27] = RNApdist_args_info_detailed_help[34];
  RNApdist_args_info_full_help[28] = RNApdist_args_info_detailed_help[35];
  RNApdist_args_info_full_help[29] = RNApdist_args_info_detailed_help[37];
  RNApdist_args_info_full_help[30] = RNApdist_args_info_detailed_help[39];
  RNApdist_args_info_full_help[31] = RNApdist_args_info_detailed_help[41];
  RNApdist_args_info_full_help[32] = RNApdist_args_info_detailed_help[43];
  RNApdist_args_info_full_help[33] = 0; 
  
}

const char *RNApdist_args_info_full_help[34];
...
init_help_array(void)
{
  ...
  RNApdist_args_info_help[5] = RNApdist_args_info_detailed_help[6];
  RNApdist_args_info_help[6] = RNApdist_args_info_detailed_help[7];
  RNApdist_args_info_help[7] = RNApdist_args_info_detailed_help[8];
  RNApdist_args_info_help[8] = RNApdist_args_info_detailed_help[14];
  RNApdist_args_info_help[9] = RNApdist_args_info_detailed_help[15];
  RNApdist_args_info_help[10] = RNApdist_args_info_detailed_help[16];
  RNApdist_args_info_help[11] = RNApdist_args_info_detailed_help[18];
  RNApdist_args_info_help[12] = RNApdist_args_info_detailed_help[20];
  RNApdist_args_info_help[13] = RNApdist_args_info_detailed_help[21];
  RNApdist_args_info_help[14] = RNApdist_args_info_detailed_help[22];
  RNApdist_args_info_help[15] = RNApdist_args_info_detailed_help[23];
  RNApdist_args_info_help[16] = RNApdist_args_info_detailed_help[27];
  RNApdist_args_info_help[17] = RNApdist_args_info_detailed_help[28];
  RNApdist_args_info_help[18] = RNApdist_args_info_detailed_help[29];
  RNApdist_args_info_help[19] = RNApdist_args_info_detailed_help[30];
  RNApdist_args_info_help[20] = RNApdist_args_info_detailed_help[31];
  RNApdist_args_info_help[21] = RNApdist_args_info_detailed_help[43];
  RNApdist_args_info_help[22] = 0; 
  
}

const char *RNApdist_args_info_help[23];
...
void clear_args (struct RNApdist_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNApdist.log");
...
void init_args_info(struct RNApdist_args_info *args_info)
{
  ...
  args_info->verbose_help = RNApdist_args_info_detailed_help[4] ;
  args_info->noconv_help = RNApdist_args_info_detailed_help[8] ;
  args_info->log_level_help = RNApdist_args_info_detailed_help[9] ;
  args_info->log_file_help = RNApdist_args_info_detailed_help[11] ;
  args_info->log_time_help = RNApdist_args_info_detailed_help[12] ;
  args_info->log_call_help = RNApdist_args_info_detailed_help[13] ;
  args_info->compare_help = RNApdist_args_info_detailed_help[16] ;
  args_info->backtrack_help = RNApdist_args_info_detailed_help[18] ;
  args_info->temp_help = RNApdist_args_info_detailed_help[22] ;
  args_info->paramFile_help = RNApdist_args_info_detailed_help[23] ;
  args_info->noTetra_help = RNApdist_args_info_detailed_help[25] ;
  args_info->salt_help = RNApdist_args_info_detailed_help[27] ;
  args_info->dangles_help = RNApdist_args_info_detailed_help[30] ;
  args_info->noLP_help = RNApdist_args_info_detailed_help[31] ;
  args_info->noGU_help = RNApdist_args_info_detailed_help[33] ;
  args_info->noClosingGU_help = RNApdist_args_info_detailed_help[34] ;
  args_info->nsp_help = RNApdist_args_info_detailed_help[35] ;
  args_info->energyModel_help = RNApdist_args_info_detailed_help[37] ;
  args_info->helical_rise_help = RNApdist_args_info_detailed_help[39] ;
  args_info->backbone_length_help = RNApdist_args_info_detailed_help[41] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvX:B::T:P:4d:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNApdist.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
