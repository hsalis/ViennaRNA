/*
  ...
  /usr/local/bin/gengetopt -i RNApvmin.ggo --file-name=RNApvmin_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNApvmin_cmdline_parser --arg-struct-name=RNApvmin_args_info
...
init_full_help_array(void)
{
  ...
  RNApvmin_args_info_full_help[5] = RNApvmin_args_info_detailed_help[6];
  RNApvmin_args_info_full_help[6] = RNApvmin_args_info_detailed_help[7];
  RNApvmin_args_info_full_help[7] = RNApvmin_args_info_detailed_help[8];
  ...
  RNApvmin_args_info_full_help[15] = RNApvmin_args_info_detailed_help[18];
  RNApvmin_args_info_full_help[16] = RNApvmin_args_info_detailed_help[20];
  RNApvmin_args_info_full_help[17] = RNApvmin_args_info_detailed_help[21];
  RNApvmin_args_info_full_help[18] = RNApvmin_args_info_detailed_help[23];
  RNApvmin_args_info_full_help[19] = RNApvmin_args_info_detailed_help[24];
  ...
  RNApvmin_args_info_full_help[22] = RNApvmin_args_info_detailed_help[30];
  RNApvmin_args_info_full_help[23] = RNApvmin_args_info_detailed_help[31];
  RNApvmin_args_info_full_help[24] = RNApvmin_args_info_detailed_help[32];
  RNApvmin_args_info_full_help[25] = RNApvmin_args_info_detailed_help[33];
  RNApvmin_args_info_full_help[26] = RNApvmin_args_info_detailed_help[34];
  RNApvmin_args_info_full_help[27] = RNApvmin_args_info_detailed_help[36];
  RNApvmin_args_info_full_help[28] = RNApvmin_args_info_detailed_help[37];
  RNApvmin_args_info_full_help[29] = RNApvmin_args_info_detailed_help[38];
  ...
  RNApvmin_args_info_full_help[38] = RNApvmin_args_info_detailed_help[49];
  RNApvmin_args_info_full_help[39] = RNApvmin_args_info_detailed_help[51];
  RNApvmin_args_info_full_help[40] = RNApvmin_args_info_detailed_help[53];
  RNApvmin_args_info_full_help[41] = RNApvmin_args_info_detailed_help[54];
  RNApvmin_args_info_full_help[42] = RNApvmin_args_info_detailed_help[55];
  RNApvmin_args_info_full_help[43] = RNApvmin_args_info_detailed_help[57];
  RNApvmin_args_info_full_help[44] = RNApvmin_args_info_detailed_help[59];
  RNApvmin_args_info_full_help[45] = RNApvmin_args_info_detailed_help[61];
  RNApvmin_args_info_full_help[46] = RNApvmin_args_info_detailed_help[63];
  RNApvmin_args_info_full_help[47] = 0; 
  
}

const char *RNApvmin_args_info_full_help[48];
...
init_help_array(void)
{
  ...
  RNApvmin_args_info_help[5] = RNApvmin_args_info_detailed_help[6];
  RNApvmin_args_info_help[6] = RNApvmin_args_info_detailed_help[7];
  RNApvmin_args_info_help[7] = RNApvmin_args_info_detailed_help[8];
  RNApvmin_args_info_help[8] = RNApvmin_args_info_detailed_help[14];
  RNApvmin_args_info_help[9] = RNApvmin_args_info_detailed_help[15];
  RNApvmin_args_info_help[10] = RNApvmin_args_info_detailed_help[16];
  RNApvmin_args_info_help[11] = RNApvmin_args_info_detailed_help[18];
  RNApvmin_args_info_help[12] = RNApvmin_args_info_detailed_help[20];
  RNApvmin_args_info_help[13] = RNApvmin_args_info_detailed_help[21];
  RNApvmin_args_info_help[14] = RNApvmin_args_info_detailed_help[23];
  RNApvmin_args_info_help[15] = RNApvmin_args_info_detailed_help[24];
  RNApvmin_args_info_help[16] = RNApvmin_args_info_detailed_help[26];
  RNApvmin_args_info_help[17] = RNApvmin_args_info_detailed_help[28];
  RNApvmin_args_info_help[18] = RNApvmin_args_info_detailed_help[36];
  RNApvmin_args_info_help[19] = RNApvmin_args_info_detailed_help[37];
  RNApvmin_args_info_help[20] = RNApvmin_args_info_detailed_help[38];
  RNApvmin_args_info_help[21] = RNApvmin_args_info_detailed_help[39];
  RNApvmin_args_info_help[22] = RNApvmin_args_info_detailed_help[40];
  RNApvmin_args_info_help[23] = RNApvmin_args_info_detailed_help[41];
  RNApvmin_args_info_help[24] = RNApvmin_args_info_detailed_help[42];
  RNApvmin_args_info_help[25] = RNApvmin_args_info_detailed_help[46];
  RNApvmin_args_info_help[26] = RNApvmin_args_info_detailed_help[47];
  RNApvmin_args_info_help[27] = RNApvmin_args_info_detailed_help[48];
  RNApvmin_args_info_help[28] = RNApvmin_args_info_detailed_help[49];
  RNApvmin_args_info_help[29] = RNApvmin_args_info_detailed_help[51];
  RNApvmin_args_info_help[30] = RNApvmin_args_info_detailed_help[63];
  RNApvmin_args_info_help[31] = 0; 
  
}

const char *RNApvmin_args_info_help[32];
...
void clear_args (struct RNApvmin_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNApvmin.log");
...
void init_args_info(struct RNApvmin_args_info *args_info)
{
  ...
  args_info->verbose_help = RNApvmin_args_info_detailed_help[4] ;
  args_info->numThreads_help = RNApvmin_args_info_detailed_help[8] ;
  args_info->log_level_help = RNApvmin_args_info_detailed_help[9] ;
  args_info->log_file_help = RNApvmin_args_info_detailed_help[11] ;
  args_info->log_time_help = RNApvmin_args_info_detailed_help[12] ;
  args_info->log_call_help = RNApvmin_args_info_detailed_help[13] ;
  args_info->shapeConversion_help = RNApvmin_args_info_detailed_help[16] ;
  args_info->tauSigmaRatio_help = RNApvmin_args_info_detailed_help[18] ;
  args_info->objectiveFunction_help = RNApvmin_args_info_detailed_help[20] ;
  args_info->sampleSize_help = RNApvmin_args_info_detailed_help[21] ;
  args_info->nonRedundant_help = RNApvmin_args_info_detailed_help[23] ;
  args_info->intermediatePath_help = RNApvmin_args_info_detailed_help[24] ;
  args_info->initialVector_help = RNApvmin_args_info_detailed_help[26] ;
  args_info->minimizer_help = RNApvmin_args_info_detailed_help[28] ;
  args_info->initialStepSize_help = RNApvmin_args_info_detailed_help[30] ;
  args_info->minStepSize_help = RNApvmin_args_info_detailed_help[31] ;
  args_info->minImprovement_help = RNApvmin_args_info_detailed_help[32] ;
  args_info->minimizerTolerance_help = RNApvmin_args_info_detailed_help[33] ;
  args_info->pfScale_help = RNApvmin_args_info_detailed_help[34] ;
  args_info->maxBPspan_help = RNApvmin_args_info_detailed_help[38] ;
  args_info->temp_help = RNApvmin_args_info_detailed_help[41] ;
  args_info->paramFile_help = RNApvmin_args_info_detailed_help[42] ;
  args_info->noTetra_help = RNApvmin_args_info_detailed_help[44] ;
  args_info->salt_help = RNApvmin_args_info_detailed_help[46] ;
  args_info->dangles_help = RNApvmin_args_info_detailed_help[49] ;
  args_info->noLP_help = RNApvmin_args_info_detailed_help[51] ;
  args_info->noGU_help = RNApvmin_args_info_detailed_help[53] ;
  args_info->noClosingGU_help = RNApvmin_args_info_detailed_help[54] ;
  args_info->nsp_help = RNApvmin_args_info_detailed_help[55] ;
  args_info->energyModel_help = RNApvmin_args_info_detailed_help[57] ;
  args_info->helical_rise_help = RNApvmin_args_info_detailed_help[59] ;
  args_info->backbone_length_help = RNApvmin_args_info_detailed_help[61] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvj:NS:T:P:4d:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNApvmin.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
