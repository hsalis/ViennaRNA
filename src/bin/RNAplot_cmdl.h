...
struct RNAplot_args_info
{
 ...
 help description.  */
  ...
  char * output_format_arg;	/**< @brief Specify output file format. (default='eps').  */
  char * output_format_orig;	/**< @brief Specify output file format. original value given at command line.  */
  const char *output_format_help; /**< @brief Specify output file format. help description.  */
 ...
 help description.  */
  float covar_threshold_arg;	/**< @brief Set the threshold of maximum counter examples for coloring consensus structure plot.
 (default='2').  */
  char * covar_threshold_orig;	/**< @brief Set the threshold of maximum counter examples for coloring consensus structure plot.
 original value given at command line.  */
  const char *covar_threshold_help; /**< @brief Set the threshold of maximum counter examples for coloring consensus structure plot.
 help description.  */
  float covar_min_sat_arg;	/**< @brief Set the minimum saturation for coloring consensus structure plot.
 (default='0.2').  */
  char * covar_min_sat_orig;	/**< @brief Set the minimum saturation for coloring consensus structure plot.
 original value given at command line.  */
  const char *covar_min_sat_help; /**< @brief Set the minimum saturation for coloring consensus structure plot.
 help description.  */
 ...
 help description.  */
  ...
  unsigned int covar_threshold_given ;	/**< @brief Whether covar-threshold was given.  */
  unsigned int covar_min_sat_given ;	/**< @brief Whether covar-min-sat was given.  */
...
extern const char *RNAplot_cmdline_parser_output_format_values[];  /**< @brief Possible values for output-format. */
extern const char *RNAplot_cmdline_parser_layout_type_values[];  /**< @brief Possible values for layout-type. */
