/*
  ...
  /usr/local/bin/gengetopt -i RNAmultifold.ggo --file-name=RNAmultifold_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAmultifold_cmdline_parser --arg-struct-name=RNAmultifold_args_info
