/*
  ...
  /usr/local/bin/gengetopt -i RNAsnoop.ggo --file-name=RNAsnoop_cmdl --include-getopt --default-optional --func-name=RNAsnoop_cmdline_parser --arg-struct-name=RNAsnoop_args_info
...
{
  RNAsnoop_args_info_full_help[0] = RNAsnoop_args_info_detailed_help[0];
  RNAsnoop_args_info_full_help[1] = RNAsnoop_args_info_detailed_help[1];
  RNAsnoop_args_info_full_help[2] = RNAsnoop_args_info_detailed_help[2];
  RNAsnoop_args_info_full_help[3] = RNAsnoop_args_info_detailed_help[3];
  RNAsnoop_args_info_full_help[4] = RNAsnoop_args_info_detailed_help[4];
  RNAsnoop_args_info_full_help[5] = RNAsnoop_args_info_detailed_help[6];
  RNAsnoop_args_info_full_help[6] = RNAsnoop_args_info_detailed_help[7];
  RNAsnoop_args_info_full_help[7] = RNAsnoop_args_info_detailed_help[8];
  RNAsnoop_args_info_full_help[8] = RNAsnoop_args_info_detailed_help[10];
  RNAsnoop_args_info_full_help[9] = RNAsnoop_args_info_detailed_help[12];
  RNAsnoop_args_info_full_help[10] = RNAsnoop_args_info_detailed_help[13];
  RNAsnoop_args_info_full_help[11] = RNAsnoop_args_info_detailed_help[14];
  RNAsnoop_args_info_full_help[12] = RNAsnoop_args_info_detailed_help[15];
  RNAsnoop_args_info_full_help[13] = RNAsnoop_args_info_detailed_help[16];
  RNAsnoop_args_info_full_help[14] = RNAsnoop_args_info_detailed_help[18];
  RNAsnoop_args_info_full_help[15] = RNAsnoop_args_info_detailed_help[19];
  RNAsnoop_args_info_full_help[16] = RNAsnoop_args_info_detailed_help[20];
  RNAsnoop_args_info_full_help[17] = RNAsnoop_args_info_detailed_help[21];
  RNAsnoop_args_info_full_help[18] = RNAsnoop_args_info_detailed_help[22];
  RNAsnoop_args_info_full_help[19] = RNAsnoop_args_info_detailed_help[23];
  RNAsnoop_args_info_full_help[20] = RNAsnoop_args_info_detailed_help[24];
  RNAsnoop_args_info_full_help[21] = RNAsnoop_args_info_detailed_help[26];
  RNAsnoop_args_info_full_help[22] = RNAsnoop_args_info_detailed_help[28];
  RNAsnoop_args_info_full_help[23] = RNAsnoop_args_info_detailed_help[30];
  RNAsnoop_args_info_full_help[24] = RNAsnoop_args_info_detailed_help[31];
  RNAsnoop_args_info_full_help[25] = RNAsnoop_args_info_detailed_help[33];
  RNAsnoop_args_info_full_help[26] = RNAsnoop_args_info_detailed_help[34];
  RNAsnoop_args_info_full_help[27] = RNAsnoop_args_info_detailed_help[35];
  RNAsnoop_args_info_full_help[28] = RNAsnoop_args_info_detailed_help[37];
  RNAsnoop_args_info_full_help[29] = RNAsnoop_args_info_detailed_help[38];
  RNAsnoop_args_info_full_help[30] = RNAsnoop_args_info_detailed_help[39];
  RNAsnoop_args_info_full_help[31] = RNAsnoop_args_info_detailed_help[40];
  RNAsnoop_args_info_full_help[32] = RNAsnoop_args_info_detailed_help[41];
  RNAsnoop_args_info_full_help[33] = RNAsnoop_args_info_detailed_help[42];
  RNAsnoop_args_info_full_help[34] = RNAsnoop_args_info_detailed_help[43];
  RNAsnoop_args_info_full_help[35] = RNAsnoop_args_info_detailed_help[44];
  RNAsnoop_args_info_full_help[36] = RNAsnoop_args_info_detailed_help[45];
  RNAsnoop_args_info_full_help[37] = RNAsnoop_args_info_detailed_help[46];
  RNAsnoop_args_info_full_help[38] = RNAsnoop_args_info_detailed_help[47];
  RNAsnoop_args_info_full_help[39] = RNAsnoop_args_info_detailed_help[48];
  RNAsnoop_args_info_full_help[40] = RNAsnoop_args_info_detailed_help[49];
  RNAsnoop_args_info_full_help[41] = RNAsnoop_args_info_detailed_help[50];
  RNAsnoop_args_info_full_help[42] = RNAsnoop_args_info_detailed_help[51];
  RNAsnoop_args_info_full_help[43] = RNAsnoop_args_info_detailed_help[52];
  RNAsnoop_args_info_full_help[44] = RNAsnoop_args_info_detailed_help[54];
  RNAsnoop_args_info_full_help[45] = RNAsnoop_args_info_detailed_help[55];
  RNAsnoop_args_info_full_help[46] = RNAsnoop_args_info_detailed_help[56];
  RNAsnoop_args_info_full_help[47] = RNAsnoop_args_info_detailed_help[58];
  RNAsnoop_args_info_full_help[48] = RNAsnoop_args_info_detailed_help[59];
  RNAsnoop_args_info_full_help[49] = 0; 
  
}

const char *RNAsnoop_args_info_full_help[50];
...
init_help_array(void)
{
  ...
  RNAsnoop_args_info_help[5] = RNAsnoop_args_info_detailed_help[6];
  ...
  RNAsnoop_args_info_help[13] = RNAsnoop_args_info_detailed_help[21];
  RNAsnoop_args_info_help[14] = RNAsnoop_args_info_detailed_help[22];
  RNAsnoop_args_info_help[15] = RNAsnoop_args_info_detailed_help[23];
  RNAsnoop_args_info_help[16] = RNAsnoop_args_info_detailed_help[24];
  RNAsnoop_args_info_help[17] = RNAsnoop_args_info_detailed_help[26];
  RNAsnoop_args_info_help[18] = RNAsnoop_args_info_detailed_help[28];
  RNAsnoop_args_info_help[19] = RNAsnoop_args_info_detailed_help[30];
  RNAsnoop_args_info_help[20] = RNAsnoop_args_info_detailed_help[31];
  RNAsnoop_args_info_help[21] = RNAsnoop_args_info_detailed_help[33];
  RNAsnoop_args_info_help[22] = RNAsnoop_args_info_detailed_help[34];
  RNAsnoop_args_info_help[23] = RNAsnoop_args_info_detailed_help[35];
  RNAsnoop_args_info_help[24] = RNAsnoop_args_info_detailed_help[37];
  RNAsnoop_args_info_help[25] = RNAsnoop_args_info_detailed_help[38];
  RNAsnoop_args_info_help[26] = RNAsnoop_args_info_detailed_help[39];
  RNAsnoop_args_info_help[27] = RNAsnoop_args_info_detailed_help[40];
  RNAsnoop_args_info_help[28] = RNAsnoop_args_info_detailed_help[41];
  RNAsnoop_args_info_help[29] = RNAsnoop_args_info_detailed_help[42];
  RNAsnoop_args_info_help[30] = RNAsnoop_args_info_detailed_help[43];
  RNAsnoop_args_info_help[31] = RNAsnoop_args_info_detailed_help[44];
  RNAsnoop_args_info_help[32] = RNAsnoop_args_info_detailed_help[45];
  RNAsnoop_args_info_help[33] = RNAsnoop_args_info_detailed_help[46];
  RNAsnoop_args_info_help[34] = RNAsnoop_args_info_detailed_help[47];
  RNAsnoop_args_info_help[35] = RNAsnoop_args_info_detailed_help[48];
  RNAsnoop_args_info_help[36] = RNAsnoop_args_info_detailed_help[49];
  RNAsnoop_args_info_help[37] = RNAsnoop_args_info_detailed_help[50];
  RNAsnoop_args_info_help[38] = RNAsnoop_args_info_detailed_help[51];
  RNAsnoop_args_info_help[39] = RNAsnoop_args_info_detailed_help[52];
  RNAsnoop_args_info_help[40] = RNAsnoop_args_info_detailed_help[54];
  RNAsnoop_args_info_help[41] = RNAsnoop_args_info_detailed_help[55];
  RNAsnoop_args_info_help[42] = RNAsnoop_args_info_detailed_help[56];
  RNAsnoop_args_info_help[43] = RNAsnoop_args_info_detailed_help[58];
  RNAsnoop_args_info_help[44] = RNAsnoop_args_info_detailed_help[59];
  RNAsnoop_args_info_help[45] = 0; 
  
}

const char *RNAsnoop_args_info_help[46];
...
void clear_args (struct RNAsnoop_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAsnoop.log");
...
void init_args_info(struct RNAsnoop_args_info *args_info)
{
  ...
  args_info->full_help_help = RNAsnoop_args_info_detailed_help[2] ;
  args_info->version_help = RNAsnoop_args_info_detailed_help[3] ;
  args_info->verbose_help = RNAsnoop_args_info_detailed_help[4] ;
  ...
  args_info->from_RNAup_help = RNAsnoop_args_info_detailed_help[14] ;
  args_info->output_directory_help = RNAsnoop_args_info_detailed_help[15] ;
  args_info->log_level_help = RNAsnoop_args_info_detailed_help[16] ;
  args_info->log_file_help = RNAsnoop_args_info_detailed_help[18] ;
  args_info->log_time_help = RNAsnoop_args_info_detailed_help[19] ;
  args_info->log_call_help = RNAsnoop_args_info_detailed_help[20] ;
  args_info->alignment_mode_help = RNAsnoop_args_info_detailed_help[23] ;
  args_info->fast_folding_help = RNAsnoop_args_info_detailed_help[24] ;
  args_info->extension_cost_help = RNAsnoop_args_info_detailed_help[26] ;
  args_info->energy_threshold_help = RNAsnoop_args_info_detailed_help[28] ;
  args_info->minimal_right_duplex_help = RNAsnoop_args_info_detailed_help[30] ;
  args_info->minimal_loop_energy_help = RNAsnoop_args_info_detailed_help[31] ;
  args_info->minimal_left_duplex_help = RNAsnoop_args_info_detailed_help[33] ;
  args_info->minimal_duplex_help = RNAsnoop_args_info_detailed_help[34] ;
  args_info->duplex_distance_help = RNAsnoop_args_info_detailed_help[35] ;
  args_info->minimal_stem_length_help = RNAsnoop_args_info_detailed_help[37] ;
  args_info->maximal_stem_length_help = RNAsnoop_args_info_detailed_help[38] ;
  args_info->minimal_duplex_box_length_help = RNAsnoop_args_info_detailed_help[39] ;
  args_info->maximal_duplex_box_length_help = RNAsnoop_args_info_detailed_help[40] ;
  args_info->minimal_snoRNA_stem_loop_length_help = RNAsnoop_args_info_detailed_help[41] ;
  args_info->maximal_snoRNA_stem_loop_length_help = RNAsnoop_args_info_detailed_help[42] ;
  args_info->minimal_snoRNA_duplex_length_help = RNAsnoop_args_info_detailed_help[43] ;
  args_info->maximal_snoRNA_duplex_length_help = RNAsnoop_args_info_detailed_help[44] ;
  args_info->minimal_duplex_stem_energy_help = RNAsnoop_args_info_detailed_help[45] ;
  args_info->minimal_total_energy_help = RNAsnoop_args_info_detailed_help[46] ;
  args_info->maximal_stem_asymmetry_help = RNAsnoop_args_info_detailed_help[47] ;
  args_info->minimal_lower_stem_energy_help = RNAsnoop_args_info_detailed_help[48] ;
  args_info->alignmentLength_help = RNAsnoop_args_info_detailed_help[49] ;
  args_info->constraint_help = RNAsnoop_args_info_detailed_help[52] ;
  args_info->produce_ps_help = RNAsnoop_args_info_detailed_help[56] ;
  args_info->direct_redraw_help = RNAsnoop_args_info_detailed_help[58] ;
...
void
RNAsnoop_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAsnoop_args_info_full_help[i])
    printf("%s\n", RNAsnoop_args_info_full_help[i++]);
}
...
.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            RNAsnoop_cmdline_parser_print_full_help ();
            RNAsnoop_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAsnoop.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
