...
.  */
 ...
 help description.  */
  int benchmark_flag;	/**< @brief Perform a prediction performance test (benchmark) based on reference structures taken from the input.
  
 (default=off).  */
  const char *benchmark_help; /**< @brief Perform a prediction performance test (benchmark) based on reference structures taken from the input.
  
 help description.  */
  char * bm_output_arg;	/**< @brief Store the performance benchmark results in a file.
  
.  */
  char * bm_output_orig;	/**< @brief Store the performance benchmark results in a file.
  
 original value given at command line.  */
  const char *bm_output_help; /**< @brief Store the performance benchmark results in a file.
  
 help description.  */
  int bm_output_append_flag;	/**< @brief Append performance benchmark data to a file instead of overwriting already existing content.
  
 (default=off).  */
  const char *bm_output_append_help; /**< @brief Append performance benchmark data to a file instead of overwriting already existing content.
  
 help description.  */
  int bm_rm_pk_flag;	/**< @brief Remove pseudo-knots from the reference structure before computing benchmark.
  
 (default=off).  */
  const char *bm_rm_pk_help; /**< @brief Remove pseudo-knots from the reference structure before computing benchmark.
...
.  */
 ...
 help description.  */
  float color_threshold_arg;	/**< @brief Set the threshold of maximum counter examples for coloring consensus structure plot.
 (default='2').  */
  char * color_threshold_orig;	/**< @brief Set the threshold of maximum counter examples for coloring consensus structure plot.
 original value given at command line.  */
  const char *color_threshold_help; /**< @brief Set the threshold of maximum counter examples for coloring consensus structure plot.
 help description.  */
  float color_min_sat_arg;	/**< @brief Set the minimum saturation for coloring consensus structure plot.
 (default='0.2').  */
  char * color_min_sat_orig;	/**< @brief Set the minimum saturation for coloring consensus structure plot.
 original value given at command line.  */
  const char *color_min_sat_help; /**< @brief Set the minimum saturation for coloring consensus structure plot.
 help description.  */
 ...
 help description.  */
  ...
  unsigned int bm_output_given ;	/**< @brief Whether bm-output was given.  */
  unsigned int bm_output_append_given ;	/**< @brief Whether bm-output-append was given.  */
  unsigned int bm_rm_pk_given ;	/**< @brief Whether bm-rm-pk was given.  */
  ...
  unsigned int color_threshold_given ;	/**< @brief Whether color-threshold was given.  */
  unsigned int color_min_sat_given ;	/**< @brief Whether color-min-sat was given.  */
