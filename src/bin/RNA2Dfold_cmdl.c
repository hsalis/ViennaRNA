/*
  ...
  /usr/local/bin/gengetopt -i RNA2Dfold.ggo --file-name=RNA2Dfold_cmdl --include-getopt --default-optional --func-name=RNA2Dfold_cmdline_parser --arg-struct-name=RNA2Dfold_args_info
...
init_full_help_array(void)
{
  ...
  RNA2Dfold_args_info_full_help[5] = RNA2Dfold_args_info_detailed_help[6];
  RNA2Dfold_args_info_full_help[6] = RNA2Dfold_args_info_detailed_help[7];
  RNA2Dfold_args_info_full_help[7] = RNA2Dfold_args_info_detailed_help[8];
  RNA2Dfold_args_info_full_help[8] = RNA2Dfold_args_info_detailed_help[9];
  RNA2Dfold_args_info_full_help[9] = RNA2Dfold_args_info_detailed_help[10];
  RNA2Dfold_args_info_full_help[10] = RNA2Dfold_args_info_detailed_help[12];
  RNA2Dfold_args_info_full_help[11] = RNA2Dfold_args_info_detailed_help[13];
  RNA2Dfold_args_info_full_help[12] = RNA2Dfold_args_info_detailed_help[14];
  RNA2Dfold_args_info_full_help[13] = RNA2Dfold_args_info_detailed_help[15];
  RNA2Dfold_args_info_full_help[14] = RNA2Dfold_args_info_detailed_help[16];
  RNA2Dfold_args_info_full_help[15] = RNA2Dfold_args_info_detailed_help[17];
  RNA2Dfold_args_info_full_help[16] = RNA2Dfold_args_info_detailed_help[18];
  RNA2Dfold_args_info_full_help[17] = RNA2Dfold_args_info_detailed_help[19];
  RNA2Dfold_args_info_full_help[18] = RNA2Dfold_args_info_detailed_help[20];
  RNA2Dfold_args_info_full_help[19] = RNA2Dfold_args_info_detailed_help[22];
  RNA2Dfold_args_info_full_help[20] = RNA2Dfold_args_info_detailed_help[24];
  RNA2Dfold_args_info_full_help[21] = RNA2Dfold_args_info_detailed_help[26];
  RNA2Dfold_args_info_full_help[22] = RNA2Dfold_args_info_detailed_help[27];
  ...
  RNA2Dfold_args_info_full_help[28] = RNA2Dfold_args_info_detailed_help[35];
  RNA2Dfold_args_info_full_help[29] = RNA2Dfold_args_info_detailed_help[36];
  RNA2Dfold_args_info_full_help[30] = RNA2Dfold_args_info_detailed_help[37];
  RNA2Dfold_args_info_full_help[31] = RNA2Dfold_args_info_detailed_help[38];
  RNA2Dfold_args_info_full_help[32] = RNA2Dfold_args_info_detailed_help[40];
  RNA2Dfold_args_info_full_help[33] = RNA2Dfold_args_info_detailed_help[41];
  RNA2Dfold_args_info_full_help[34] = RNA2Dfold_args_info_detailed_help[42];
  RNA2Dfold_args_info_full_help[35] = RNA2Dfold_args_info_detailed_help[44];
  RNA2Dfold_args_info_full_help[36] = RNA2Dfold_args_info_detailed_help[46];
  RNA2Dfold_args_info_full_help[37] = 0; 
  
}

const char *RNA2Dfold_args_info_full_help[38];
...
init_help_array(void)
{
  ...
  RNA2Dfold_args_info_help[5] = RNA2Dfold_args_info_detailed_help[6];
  RNA2Dfold_args_info_help[6] = RNA2Dfold_args_info_detailed_help[7];
  RNA2Dfold_args_info_help[7] = RNA2Dfold_args_info_detailed_help[8];
  RNA2Dfold_args_info_help[8] = RNA2Dfold_args_info_detailed_help[9];
  RNA2Dfold_args_info_help[9] = RNA2Dfold_args_info_detailed_help[15];
  RNA2Dfold_args_info_help[10] = RNA2Dfold_args_info_detailed_help[16];
  RNA2Dfold_args_info_help[11] = RNA2Dfold_args_info_detailed_help[17];
  RNA2Dfold_args_info_help[12] = RNA2Dfold_args_info_detailed_help[18];
  RNA2Dfold_args_info_help[13] = RNA2Dfold_args_info_detailed_help[19];
  RNA2Dfold_args_info_help[14] = RNA2Dfold_args_info_detailed_help[20];
  RNA2Dfold_args_info_help[15] = RNA2Dfold_args_info_detailed_help[22];
  RNA2Dfold_args_info_help[16] = RNA2Dfold_args_info_detailed_help[26];
  RNA2Dfold_args_info_help[17] = RNA2Dfold_args_info_detailed_help[27];
  RNA2Dfold_args_info_help[18] = RNA2Dfold_args_info_detailed_help[28];
  RNA2Dfold_args_info_help[19] = RNA2Dfold_args_info_detailed_help[29];
  RNA2Dfold_args_info_help[20] = RNA2Dfold_args_info_detailed_help[30];
  RNA2Dfold_args_info_help[21] = RNA2Dfold_args_info_detailed_help[31];
  RNA2Dfold_args_info_help[22] = RNA2Dfold_args_info_detailed_help[35];
  RNA2Dfold_args_info_help[23] = RNA2Dfold_args_info_detailed_help[36];
  RNA2Dfold_args_info_help[24] = RNA2Dfold_args_info_detailed_help[37];
  RNA2Dfold_args_info_help[25] = RNA2Dfold_args_info_detailed_help[38];
  RNA2Dfold_args_info_help[26] = RNA2Dfold_args_info_detailed_help[46];
  RNA2Dfold_args_info_help[27] = 0; 
  
}

const char *RNA2Dfold_args_info_help[28];
...
void clear_args (struct RNA2Dfold_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNA2Dfold.log");
...
void init_args_info(struct RNA2Dfold_args_info *args_info)
{
  ...
  args_info->verbose_help = RNA2Dfold_args_info_detailed_help[4] ;
  args_info->numThreads_help = RNA2Dfold_args_info_detailed_help[8] ;
  args_info->noconv_help = RNA2Dfold_args_info_detailed_help[9] ;
  args_info->log_level_help = RNA2Dfold_args_info_detailed_help[10] ;
  args_info->log_file_help = RNA2Dfold_args_info_detailed_help[12] ;
  args_info->log_time_help = RNA2Dfold_args_info_detailed_help[13] ;
  args_info->log_call_help = RNA2Dfold_args_info_detailed_help[14] ;
  args_info->partfunc_help = RNA2Dfold_args_info_detailed_help[17] ;
  args_info->stochBT_help = RNA2Dfold_args_info_detailed_help[18] ;
  args_info->neighborhood_help = RNA2Dfold_args_info_detailed_help[19] ;
  args_info->neighborhood_min = 0;
  args_info->neighborhood_max = 0;
  args_info->maxDist1_help = RNA2Dfold_args_info_detailed_help[20] ;
  args_info->maxDist2_help = RNA2Dfold_args_info_detailed_help[22] ;
  args_info->pfScale_help = RNA2Dfold_args_info_detailed_help[24] ;
  args_info->noBT_help = RNA2Dfold_args_info_detailed_help[26] ;
  args_info->circ_help = RNA2Dfold_args_info_detailed_help[27] ;
  args_info->temp_help = RNA2Dfold_args_info_detailed_help[30] ;
  args_info->paramFile_help = RNA2Dfold_args_info_detailed_help[31] ;
  args_info->noTetra_help = RNA2Dfold_args_info_detailed_help[33] ;
  args_info->salt_help = RNA2Dfold_args_info_detailed_help[35] ;
  args_info->dangles_help = RNA2Dfold_args_info_detailed_help[38] ;
  args_info->noGU_help = RNA2Dfold_args_info_detailed_help[40] ;
  args_info->noClosingGU_help = RNA2Dfold_args_info_detailed_help[41] ;
  args_info->helical_rise_help = RNA2Dfold_args_info_detailed_help[42] ;
  args_info->backbone_length_help = RNA2Dfold_args_info_detailed_help[44] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvj:pK:L:S:cT:P:4d:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNA2Dfold.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
