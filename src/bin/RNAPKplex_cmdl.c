/*
  ...
  /usr/local/bin/gengetopt -i RNAPKplex.ggo --file-name=RNAPKplex_cmdl --include-getopt --default-optional --func-name=PKplex_cmdline_parser --arg-struct-name=PKplex_args_info
...
init_full_help_array(void)
{
  ...
  PKplex_args_info_full_help[5] = PKplex_args_info_detailed_help[6];
  PKplex_args_info_full_help[6] = PKplex_args_info_detailed_help[7];
  PKplex_args_info_full_help[7] = PKplex_args_info_detailed_help[8];
  PKplex_args_info_full_help[8] = PKplex_args_info_detailed_help[9];
  PKplex_args_info_full_help[9] = PKplex_args_info_detailed_help[11];
  PKplex_args_info_full_help[10] = PKplex_args_info_detailed_help[12];
  PKplex_args_info_full_help[11] = PKplex_args_info_detailed_help[13];
  PKplex_args_info_full_help[12] = PKplex_args_info_detailed_help[14];
  PKplex_args_info_full_help[13] = PKplex_args_info_detailed_help[15];
  PKplex_args_info_full_help[14] = PKplex_args_info_detailed_help[16];
  PKplex_args_info_full_help[15] = PKplex_args_info_detailed_help[17];
  PKplex_args_info_full_help[16] = PKplex_args_info_detailed_help[18];
  PKplex_args_info_full_help[17] = PKplex_args_info_detailed_help[20];
  PKplex_args_info_full_help[18] = PKplex_args_info_detailed_help[22];
  PKplex_args_info_full_help[19] = PKplex_args_info_detailed_help[24];
  PKplex_args_info_full_help[20] = PKplex_args_info_detailed_help[25];
  PKplex_args_info_full_help[21] = PKplex_args_info_detailed_help[26];
  PKplex_args_info_full_help[22] = PKplex_args_info_detailed_help[27];
  PKplex_args_info_full_help[23] = PKplex_args_info_detailed_help[29];
  PKplex_args_info_full_help[24] = PKplex_args_info_detailed_help[31];
  PKplex_args_info_full_help[25] = PKplex_args_info_detailed_help[32];
  PKplex_args_info_full_help[26] = PKplex_args_info_detailed_help[33];
  PKplex_args_info_full_help[27] = PKplex_args_info_detailed_help[34];
  PKplex_args_info_full_help[28] = PKplex_args_info_detailed_help[36];
  PKplex_args_info_full_help[29] = PKplex_args_info_detailed_help[37];
  PKplex_args_info_full_help[30] = PKplex_args_info_detailed_help[38];
  PKplex_args_info_full_help[31] = PKplex_args_info_detailed_help[40];
  PKplex_args_info_full_help[32] = PKplex_args_info_detailed_help[42];
  PKplex_args_info_full_help[33] = PKplex_args_info_detailed_help[44];
  PKplex_args_info_full_help[34] = 0; 
  
}

const char *PKplex_args_info_full_help[35];
...
init_help_array(void)
{
  ...
  PKplex_args_info_help[5] = PKplex_args_info_detailed_help[6];
  PKplex_args_info_help[6] = PKplex_args_info_detailed_help[7];
  PKplex_args_info_help[7] = PKplex_args_info_detailed_help[8];
  PKplex_args_info_help[8] = PKplex_args_info_detailed_help[14];
  PKplex_args_info_help[9] = PKplex_args_info_detailed_help[15];
  PKplex_args_info_help[10] = PKplex_args_info_detailed_help[16];
  PKplex_args_info_help[11] = PKplex_args_info_detailed_help[17];
  PKplex_args_info_help[12] = PKplex_args_info_detailed_help[18];
  PKplex_args_info_help[13] = PKplex_args_info_detailed_help[24];
  PKplex_args_info_help[14] = PKplex_args_info_detailed_help[25];
  PKplex_args_info_help[15] = PKplex_args_info_detailed_help[26];
  PKplex_args_info_help[16] = PKplex_args_info_detailed_help[27];
  PKplex_args_info_help[17] = PKplex_args_info_detailed_help[31];
  PKplex_args_info_help[18] = PKplex_args_info_detailed_help[32];
  PKplex_args_info_help[19] = PKplex_args_info_detailed_help[33];
  PKplex_args_info_help[20] = PKplex_args_info_detailed_help[34];
  PKplex_args_info_help[21] = PKplex_args_info_detailed_help[44];
...
void clear_args (struct PKplex_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAPKplex.log");
  args_info->log_file_orig = NULL;
  args_info->log_time_flag = 0;
  args_info->log_call_flag = 0;
  args_info->cutoff_arg = 1e-6;
...
void init_args_info(struct PKplex_args_info *args_info)
{
  ...
  args_info->noconv_help = PKplex_args_info_detailed_help[8] ;
  args_info->log_level_help = PKplex_args_info_detailed_help[9] ;
  args_info->log_file_help = PKplex_args_info_detailed_help[11] ;
  args_info->log_time_help = PKplex_args_info_detailed_help[12] ;
  args_info->log_call_help = PKplex_args_info_detailed_help[13] ;
  args_info->cutoff_help = PKplex_args_info_detailed_help[16] ;
  args_info->energyCutoff_help = PKplex_args_info_detailed_help[17] ;
  args_info->subopts_help = PKplex_args_info_detailed_help[18] ;
  args_info->betaScale_help = PKplex_args_info_detailed_help[20] ;
  args_info->pfScale_help = PKplex_args_info_detailed_help[22] ;
  args_info->temp_help = PKplex_args_info_detailed_help[26] ;
  args_info->paramFile_help = PKplex_args_info_detailed_help[27] ;
  args_info->noTetra_help = PKplex_args_info_detailed_help[29] ;
  args_info->salt_help = PKplex_args_info_detailed_help[31] ;
  args_info->noLP_help = PKplex_args_info_detailed_help[34] ;
  args_info->noGU_help = PKplex_args_info_detailed_help[36] ;
  args_info->noClosingGU_help = PKplex_args_info_detailed_help[37] ;
  args_info->nsp_help = PKplex_args_info_detailed_help[38] ;
  args_info->helical_rise_help = PKplex_args_info_detailed_help[40] ;
  args_info->backbone_length_help = PKplex_args_info_detailed_help[42] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvc:e:s:S:T:P:4", long_options, &option_index);
...
.  */
          ...
          break;
        case 'c':	/* Only consider unpaired probabities > cutoff for putative PK sites.
...
.  */
          ...
          if (update_arg( (void *)&(args_info->cutoff_arg), 
              ...
              &(local_args_info.cutoff_given), optarg, 0, "1e-6", ARG_FLOAT,
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAPKplex.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
