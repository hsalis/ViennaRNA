/*
  ...
  /usr/local/bin/gengetopt -i RNApaln.ggo --file-name=RNApaln_cmdl --include-getopt --default-optional --func-name=RNApaln_cmdline_parser --arg-struct-name=RNApaln_args_info
...
init_full_help_array(void)
{
  ...
  RNApaln_args_info_full_help[5] = RNApaln_args_info_detailed_help[6];
  RNApaln_args_info_full_help[6] = RNApaln_args_info_detailed_help[7];
  RNApaln_args_info_full_help[7] = RNApaln_args_info_detailed_help[8];
  RNApaln_args_info_full_help[8] = RNApaln_args_info_detailed_help[10];
  RNApaln_args_info_full_help[9] = RNApaln_args_info_detailed_help[11];
  RNApaln_args_info_full_help[10] = RNApaln_args_info_detailed_help[13];
  RNApaln_args_info_full_help[11] = RNApaln_args_info_detailed_help[14];
  RNApaln_args_info_full_help[12] = RNApaln_args_info_detailed_help[15];
  RNApaln_args_info_full_help[13] = RNApaln_args_info_detailed_help[16];
  RNApaln_args_info_full_help[14] = RNApaln_args_info_detailed_help[17];
  RNApaln_args_info_full_help[15] = RNApaln_args_info_detailed_help[18];
  RNApaln_args_info_full_help[16] = RNApaln_args_info_detailed_help[20];
  RNApaln_args_info_full_help[17] = RNApaln_args_info_detailed_help[21];
  RNApaln_args_info_full_help[18] = RNApaln_args_info_detailed_help[22];
  RNApaln_args_info_full_help[19] = RNApaln_args_info_detailed_help[23];
  ...
  RNApaln_args_info_full_help[28] = RNApaln_args_info_detailed_help[34];
  RNApaln_args_info_full_help[29] = RNApaln_args_info_detailed_help[36];
  RNApaln_args_info_full_help[30] = RNApaln_args_info_detailed_help[38];
  RNApaln_args_info_full_help[31] = RNApaln_args_info_detailed_help[39];
  RNApaln_args_info_full_help[32] = RNApaln_args_info_detailed_help[40];
  RNApaln_args_info_full_help[33] = RNApaln_args_info_detailed_help[42];
  RNApaln_args_info_full_help[34] = RNApaln_args_info_detailed_help[44];
  RNApaln_args_info_full_help[35] = RNApaln_args_info_detailed_help[46];
  RNApaln_args_info_full_help[36] = RNApaln_args_info_detailed_help[48];
  RNApaln_args_info_full_help[37] = 0; 
  
}

const char *RNApaln_args_info_full_help[38];
...
init_help_array(void)
{
  ...
  RNApaln_args_info_help[5] = RNApaln_args_info_detailed_help[6];
  RNApaln_args_info_help[6] = RNApaln_args_info_detailed_help[7];
  RNApaln_args_info_help[7] = RNApaln_args_info_detailed_help[8];
  RNApaln_args_info_help[8] = RNApaln_args_info_detailed_help[10];
  RNApaln_args_info_help[9] = RNApaln_args_info_detailed_help[16];
  RNApaln_args_info_help[10] = RNApaln_args_info_detailed_help[17];
  RNApaln_args_info_help[11] = RNApaln_args_info_detailed_help[18];
  RNApaln_args_info_help[12] = RNApaln_args_info_detailed_help[20];
  RNApaln_args_info_help[13] = RNApaln_args_info_detailed_help[21];
  RNApaln_args_info_help[14] = RNApaln_args_info_detailed_help[22];
  RNApaln_args_info_help[15] = RNApaln_args_info_detailed_help[23];
  RNApaln_args_info_help[16] = RNApaln_args_info_detailed_help[24];
  RNApaln_args_info_help[17] = RNApaln_args_info_detailed_help[25];
  RNApaln_args_info_help[18] = RNApaln_args_info_detailed_help[26];
  RNApaln_args_info_help[19] = RNApaln_args_info_detailed_help[27];
  RNApaln_args_info_help[20] = RNApaln_args_info_detailed_help[31];
  RNApaln_args_info_help[21] = RNApaln_args_info_detailed_help[32];
  RNApaln_args_info_help[22] = RNApaln_args_info_detailed_help[33];
  RNApaln_args_info_help[23] = RNApaln_args_info_detailed_help[34];
  RNApaln_args_info_help[24] = RNApaln_args_info_detailed_help[36];
  RNApaln_args_info_help[25] = RNApaln_args_info_detailed_help[48];
  RNApaln_args_info_help[26] = 0; 
  
}

const char *RNApaln_args_info_help[27];
...
void clear_args (struct RNApaln_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNApaln.log");
...
void init_args_info(struct RNApaln_args_info *args_info)
{
  ...
  args_info->verbose_help = RNApaln_args_info_detailed_help[4] ;
  args_info->printAlignment_help = RNApaln_args_info_detailed_help[8] ;
  args_info->noconv_help = RNApaln_args_info_detailed_help[10] ;
  args_info->log_level_help = RNApaln_args_info_detailed_help[11] ;
  args_info->log_file_help = RNApaln_args_info_detailed_help[13] ;
  args_info->log_time_help = RNApaln_args_info_detailed_help[14] ;
  args_info->log_call_help = RNApaln_args_info_detailed_help[15] ;
  args_info->mode_help = RNApaln_args_info_detailed_help[18] ;
  args_info->gapo_help = RNApaln_args_info_detailed_help[20] ;
  args_info->gape_help = RNApaln_args_info_detailed_help[21] ;
  args_info->seqw_help = RNApaln_args_info_detailed_help[22] ;
  args_info->endgaps_help = RNApaln_args_info_detailed_help[23] ;
  args_info->temp_help = RNApaln_args_info_detailed_help[26] ;
  args_info->paramFile_help = RNApaln_args_info_detailed_help[27] ;
  args_info->noTetra_help = RNApaln_args_info_detailed_help[29] ;
  args_info->salt_help = RNApaln_args_info_detailed_help[31] ;
  args_info->dangles_help = RNApaln_args_info_detailed_help[34] ;
  args_info->noLP_help = RNApaln_args_info_detailed_help[36] ;
  args_info->noGU_help = RNApaln_args_info_detailed_help[38] ;
  args_info->noClosingGU_help = RNApaln_args_info_detailed_help[39] ;
  args_info->nsp_help = RNApaln_args_info_detailed_help[40] ;
  args_info->energyModel_help = RNApaln_args_info_detailed_help[42] ;
  args_info->helical_rise_help = RNApaln_args_info_detailed_help[44] ;
  args_info->backbone_length_help = RNApaln_args_info_detailed_help[46] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvB::X:T:P:4d:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNApaln.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
