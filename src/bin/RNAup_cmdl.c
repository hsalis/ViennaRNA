/*
  ...
  /usr/local/bin/gengetopt -i RNAup.ggo --file-name=RNAup_cmdl --include-getopt --default-optional --func-name=RNAup_cmdline_parser --arg-struct-name=RNAup_args_info
...
init_full_help_array(void)
{
  ...
  RNAup_args_info_full_help[5] = RNAup_args_info_detailed_help[6];
  RNAup_args_info_full_help[6] = RNAup_args_info_detailed_help[7];
  ...
  RNAup_args_info_full_help[11] = RNAup_args_info_detailed_help[13];
  ...
  RNAup_args_info_full_help[16] = RNAup_args_info_detailed_help[18];
  RNAup_args_info_full_help[17] = RNAup_args_info_detailed_help[20];
  RNAup_args_info_full_help[18] = RNAup_args_info_detailed_help[22];
  RNAup_args_info_full_help[19] = RNAup_args_info_detailed_help[23];
  RNAup_args_info_full_help[20] = RNAup_args_info_detailed_help[24];
  RNAup_args_info_full_help[21] = RNAup_args_info_detailed_help[26];
  RNAup_args_info_full_help[22] = RNAup_args_info_detailed_help[28];
  RNAup_args_info_full_help[23] = RNAup_args_info_detailed_help[30];
  RNAup_args_info_full_help[24] = RNAup_args_info_detailed_help[32];
  RNAup_args_info_full_help[25] = RNAup_args_info_detailed_help[34];
  RNAup_args_info_full_help[26] = RNAup_args_info_detailed_help[36];
  RNAup_args_info_full_help[27] = RNAup_args_info_detailed_help[37];
  ...
  RNAup_args_info_full_help[33] = RNAup_args_info_detailed_help[45];
  RNAup_args_info_full_help[34] = RNAup_args_info_detailed_help[47];
  ...
  RNAup_args_info_full_help[38] = RNAup_args_info_detailed_help[51];
  RNAup_args_info_full_help[39] = RNAup_args_info_detailed_help[53];
  RNAup_args_info_full_help[40] = RNAup_args_info_detailed_help[55];
  RNAup_args_info_full_help[41] = RNAup_args_info_detailed_help[56];
  RNAup_args_info_full_help[42] = RNAup_args_info_detailed_help[57];
  RNAup_args_info_full_help[43] = RNAup_args_info_detailed_help[59];
  RNAup_args_info_full_help[44] = RNAup_args_info_detailed_help[61];
  RNAup_args_info_full_help[45] = RNAup_args_info_detailed_help[63];
  RNAup_args_info_full_help[46] = RNAup_args_info_detailed_help[65];
  RNAup_args_info_full_help[47] = 0; 
  
}

const char *RNAup_args_info_full_help[48];
...
init_help_array(void)
{
  ...
  RNAup_args_info_help[5] = RNAup_args_info_detailed_help[6];
  RNAup_args_info_help[6] = RNAup_args_info_detailed_help[7];
  ...
  RNAup_args_info_help[10] = RNAup_args_info_detailed_help[16];
  RNAup_args_info_help[11] = RNAup_args_info_detailed_help[17];
  RNAup_args_info_help[12] = RNAup_args_info_detailed_help[18];
  RNAup_args_info_help[13] = RNAup_args_info_detailed_help[20];
  RNAup_args_info_help[14] = RNAup_args_info_detailed_help[22];
  RNAup_args_info_help[15] = RNAup_args_info_detailed_help[23];
  RNAup_args_info_help[16] = RNAup_args_info_detailed_help[24];
  RNAup_args_info_help[17] = RNAup_args_info_detailed_help[26];
  RNAup_args_info_help[18] = RNAup_args_info_detailed_help[28];
  RNAup_args_info_help[19] = RNAup_args_info_detailed_help[30];
  RNAup_args_info_help[20] = RNAup_args_info_detailed_help[32];
  RNAup_args_info_help[21] = RNAup_args_info_detailed_help[36];
  RNAup_args_info_help[22] = RNAup_args_info_detailed_help[37];
  RNAup_args_info_help[23] = RNAup_args_info_detailed_help[38];
  RNAup_args_info_help[24] = RNAup_args_info_detailed_help[40];
  RNAup_args_info_help[25] = RNAup_args_info_detailed_help[41];
  RNAup_args_info_help[26] = RNAup_args_info_detailed_help[42];
  RNAup_args_info_help[27] = RNAup_args_info_detailed_help[43];
  RNAup_args_info_help[28] = RNAup_args_info_detailed_help[47];
  RNAup_args_info_help[29] = RNAup_args_info_detailed_help[49];
  RNAup_args_info_help[30] = RNAup_args_info_detailed_help[50];
  RNAup_args_info_help[31] = RNAup_args_info_detailed_help[51];
  RNAup_args_info_help[32] = RNAup_args_info_detailed_help[53];
  RNAup_args_info_help[33] = RNAup_args_info_detailed_help[65];
  RNAup_args_info_help[34] = 0; 
  
}

const char *RNAup_args_info_help[35];
...
void clear_args (struct RNAup_args_info *args_info)
{
  ...
  args_info->log_file_arg = gengetopt_strdup ("RNAup.log");
...
void init_args_info(struct RNAup_args_info *args_info)
{
  ...
  args_info->verbose_help = RNAup_args_info_detailed_help[4] ;
  ...
  args_info->log_level_help = RNAup_args_info_detailed_help[11] ;
  args_info->log_file_help = RNAup_args_info_detailed_help[13] ;
  args_info->log_time_help = RNAup_args_info_detailed_help[14] ;
  args_info->log_call_help = RNAup_args_info_detailed_help[15] ;
  args_info->ulength_help = RNAup_args_info_detailed_help[18] ;
  args_info->ulength_min = 0;
  args_info->ulength_max = 0;
  args_info->contributions_help = RNAup_args_info_detailed_help[20] ;
  args_info->window_help = RNAup_args_info_detailed_help[23] ;
  args_info->include_both_help = RNAup_args_info_detailed_help[24] ;
  args_info->extend5_help = RNAup_args_info_detailed_help[26] ;
  args_info->extend3_help = RNAup_args_info_detailed_help[28] ;
  args_info->interaction_pairwise_help = RNAup_args_info_detailed_help[30] ;
  args_info->interaction_first_help = RNAup_args_info_detailed_help[32] ;
  args_info->pfScale_help = RNAup_args_info_detailed_help[34] ;
  args_info->constraint_help = RNAup_args_info_detailed_help[38] ;
  args_info->temp_help = RNAup_args_info_detailed_help[42] ;
  args_info->paramFile_help = RNAup_args_info_detailed_help[43] ;
  args_info->noTetra_help = RNAup_args_info_detailed_help[45] ;
  args_info->salt_help = RNAup_args_info_detailed_help[47] ;
  args_info->saltInit_help = RNAup_args_info_detailed_help[48] ;
  args_info->dangles_help = RNAup_args_info_detailed_help[51] ;
  args_info->noLP_help = RNAup_args_info_detailed_help[53] ;
  args_info->noGU_help = RNAup_args_info_detailed_help[55] ;
  args_info->noClosingGU_help = RNAup_args_info_detailed_help[56] ;
  args_info->nsp_help = RNAup_args_info_detailed_help[57] ;
  args_info->energyModel_help = RNAup_args_info_detailed_help[59] ;
  args_info->helical_rise_help = RNAup_args_info_detailed_help[61] ;
  args_info->backbone_length_help = RNAup_args_info_detailed_help[63] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvou:c:w:b5:3:S:CT:P:4d:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "log-file") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->log_file_arg), 
                ...
                &(local_args_info.log_file_given), optarg, 0, "RNAup.log", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "log-file", '-',
                additional_error))
              goto failure;
